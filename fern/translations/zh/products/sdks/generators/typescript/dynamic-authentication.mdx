...
查看 [TypeScript 配置页面](/learn/sdks/generators/typescript/configuration#packagejson) 了解所有可用的 packageJson 选项。
...
- [添加自定义代码](/learn/sdks/generators/typescript/custom-code) - TypeScript 特定的自定义指南
- [TypeScript 配置](/learn/sdks/generators/typescript/configuration) - 配置选项的完整列表