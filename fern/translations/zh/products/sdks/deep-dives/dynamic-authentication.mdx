...
- [添加自定义代码](/learn/sdks/overview/custom-code) - 了解更多关于扩展生成的 SDK
- [TypeScript 自定义代码](/learn/sdks/generators/typescript/custom-code) - TypeScript 特定的自定义指南
- [Python 自定义代码](/learn/sdks/generators/python/custom-code) - Python 特定的自定义指南