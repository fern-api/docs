...
Fern SDK 生成[默认运行在 Fern 的基础设施上](/learn/sdks/overview/how-it-works)。自托管允许您在自己的基础设施上运行 SDK 生成。如果您的组织有以下需求，可以使用自托管：
...
* 初始化了 `fern` 文件夹。请参阅[设置 `fern` 文件夹](/learn/sdks/overview/quickstart)。
* 在 `generators.yml` 中配置了 SDK 生成器。请参阅特定语言的快速开始指南：[TypeScript](/learn/sdks/generators/typescript/quickstart)、[Python](/learn/sdks/generators/python/quickstart)、[Go](/learn/sdks/generators/go/quickstart)、[Java](/learn/sdks/generators/java/quickstart) 等。
</Info>
