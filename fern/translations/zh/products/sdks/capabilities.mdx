...
<CardGroup cols={3}>
  ...
  <Card title="惯用方法名" icon="fa-duotone fa-code" href="/sdks/deep-dives/customize-method-names">
    精细调整 SDK 资源和方法名称
  ...
  <Card title="模式验证" icon="fa-duotone fa-check-circle" href="/sdks/deep-dives/testing#mock-server-tests">
    当负载与您的模式不符时快速失败
  ...
  <Card title="判别联合" icon="fa-duotone fa-code-branch" href="/api-definitions/ferndef/types#discriminated-unions">
    Fern SDK 包含对判别联合的支持
  ...
  <Card title="自动分页" icon="fa-solid fa-list" href="/sdks/deep-dives/auto-pagination">
  ...
  <Card title="OAuth 令牌刷新" icon="fa-duotone fa-arrows-rotate" href="/sdks/reference/generators-yml#oauth">
  ...
  <Card title="带退避的重试" icon="fa-duotone fa-repeat" href="/sdks/deep-dives/retries-with-backoff">
    使用指数退避算法自动重试失败的请求
  ...
  <Card title="幂等性标头" icon="fa-solid fa-shield" href="/sdks/deep-dives/idempotency">
    内置防止重复提交的保护
  ...
  <Card title="服务器发送事件" icon="fa-duotone fa-broadcast-tower" href="/api-definitions/openapi/endpoints/sse">
  ...
  <Card title="测试" icon="fa-duotone fa-flask" href="/sdks/deep-dives/testing">
  ...
  <Card title="代码片段" icon="fa-duotone fa-brackets-curly" href="/docs/api-references/sdk-snippets">
    不再依赖手动编写的代码片段
  ...
  <Card title="使用自定义代码扩展" icon="fa-duotone fa-puzzle-piece" href="/sdks/overview/custom-code">
    扩展生成的 SDK 以提供额外功能
  ...
  <Card title="合并多个 API" icon="fa-duotone fa-code-merge" href="/api-definitions/overview/project-structure#multiple-apis">
    多个 API 定义，一个 SDK。
