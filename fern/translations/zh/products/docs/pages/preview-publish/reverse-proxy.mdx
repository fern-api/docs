...
当您将 Fern 文档托管在[子路径](/learn/docs/preview-publish/setting-up-your-domain)（如 `mydomain.com/docs`）上时，您的基础设施必须将该路径的请求代理到 Fern 的源站。子域名设置（`docs.mydomain.com`）使用 CNAME 记录，不需要反向代理。
