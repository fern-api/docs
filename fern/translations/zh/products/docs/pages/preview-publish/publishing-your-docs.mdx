...
当您发布文档时，Fern 会为您托管它们。您也可以[将文档发布到自定义域名](/learn/docs/preview-publish/setting-up-your-domain)。

### 自托管您的文档

如果您需要离线访问文档或想在自己的服务器上托管文档，Fern [也提供该选项](/learn/docs/self-hosted/overview)。自托管文档对某些功能的访问受限（包括 Ask Fern 和分析功能）。
