...
sidebar-title: 单点登录
description: "使用 SAML 或 OIDC 单点登录,将文档置于公司身份提供商之后,让员工和合作伙伴使用现有凭证登录。"
---
...
<Note>SSO 提供基于登录的访问控制，但不支持角色管理或 API 密钥注入。要进行细粒度访问控制，请使用[RBAC](/learn/docs/authentication/features/rbac)。</Note>
