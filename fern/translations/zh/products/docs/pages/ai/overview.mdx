...
无论用户在何处工作，都能即时获取来自您文档的带引用答案。Ask AI 提供以下形式：嵌入式聊天小部件、用于自定义集成的 [API](/learn/docs/ai-features/ask-ai/api-reference/overview)，以及面向社区的 [Slack 应用](/learn/docs/ai-features/ask-ai/slack-app)。对于使用 Claude Code、Cursor、Windsurf 等 AI 客户端的开发者，Fern 还托管了 MCP 服务器，便于他们直接从开发环境中查询文档。
