...
通过在[页面操作栏](/learn/docs/configuration/site-level-settings#page-actions-configuration)中添加"安装技能"按钮来在文档 UI 中展示您的技能。在 `docs.yml` 中设置 `page-actions.options.skills`，按钮会打开一个弹窗，包含可复制的安装命令、可用技能列表以及可选的源仓库链接。
