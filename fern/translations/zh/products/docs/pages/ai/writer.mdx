...
为您的组织[获取唯一的 Slack 安装链接](/learn/zh/docs/scribe-api/fern-writer-api/get-fern-writer-install-link)。提供：
- 您的 [Fern token](/learn/zh/cli-api-reference/cli-reference/commands#fern-token)
