...
Fern 会自动为每个启用了 [Ask AI](/learn/docs/ai-features/ask-ai/overview) 的文档站点生成并托管一个生产就绪的 [Model Context Protocol (MCP)](https://modelcontextprotocol.io) 服务器。该服务器将 AI 客户端（如 Claude Code、Cursor 和 Windsurf）连接到您的文档作为外部数据源，这样开发者就可以直接在开发环境中获得关于您产品的即时答案。
