...
<CardGroup cols={2}>
  ...
  <Card title="URL Slug" icon="fa-duotone fa-link" href="/learn/docs/seo/configuring-slugs">
  ...
  <Card title="自定义 robots.txt" icon="fa-duotone fa-robot" href="/learn/docs/seo/robots-txt">
