...
sidebar-title: 自动更新最后修改日期
---

您可以使用 GitHub Action 在拉取请求中修改 MDX 文件时自动更新 [`last-updated` 前置属性](/learn/zh/docs/configuration/page-level-settings#last-updated)。这样可以让您的文档"最后更新"时间戳保持准确，无需手动更新。
