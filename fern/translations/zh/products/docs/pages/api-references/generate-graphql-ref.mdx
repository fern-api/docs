...
<Tip>
  查看[在线示例](https://docs.bigcommerce.com/developer/api-reference/graphql/overview)或浏览 [GitHub 源代码](https://github.com/fern-api/docs-examples/tree/main/graphql)。
</Tip>
...
<ParamField path="api.specs[].origin">
  您的 GraphQL API 端点 URL。Fern 对此端点执行[内省](https://graphql.org/learn/introspection/)以获取 schema。设置后，[运行 `fern api update`](/learn/zh/cli-api-reference/cli-reference/commands#fern-api-update) 会从此端点更新本地 schema。
</ParamField>