---
title: 指导
description: 配置自定义指导来覆盖 Ask AI 对特定查询的响应。控制敏感内容，如账单和法律条款。
sidebar-title: 指南
---

您可以添加自定义指导来"覆盖" Ask AI 对特定用户查询的响应。这对于您可能不希望在文档中明确显示的内容（如账单信息、法律条款和其他敏感内容）非常有用。
...
有关更多详细信息，请参阅 [API 参考](/learn/docs/ai-features/ask-ai/api-reference/guidance/create-guidance)。
...
Ask AI 优先使用指导响应而不是其他文档响应，允许您覆盖默认的 RAG 响应。
