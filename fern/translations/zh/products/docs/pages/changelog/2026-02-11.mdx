...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/self-hosted/authentication#api-key-injection">阅读文档</Button>
...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/authentication/setup/jwt#build-the-fern-claim">阅读文档</Button>