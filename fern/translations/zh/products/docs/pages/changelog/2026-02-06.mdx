...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/ai-features/ask-fern/overview#deep-linking">阅读文档</Button>
...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/configuration/site-level-settings#settingsfolder-title-source">阅读文档</Button>