...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/writing-content/components/download">阅读文档</Button>
...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/configuration/navigation#collapsed-sections-or-folders">阅读文档</Button>