...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/configuration/site-level-settings#navbar-links-configuration">阅读文档</Button>
...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/configuration/site-level-settings#settingsdisable-explorer-proxy">阅读文档</Button>