...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/configuration/site-level-settings#logo-configuration">阅读文档</Button>
...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/configuration/site-level-settings#theme-configuration">阅读文档</Button>