...
Fern 存储来自 Slack 交互的所有问题和答案用于[分析目的](/learn/docs/ai-features/ask-ai/overview#analytics)。
...
使用 [API Explorer](/learn/docs/ai-features/ask-ai/api-reference/slack-ask-fern/get-slack-install-link) 获取您组织的专属 Slack 安装链接。请提供：
