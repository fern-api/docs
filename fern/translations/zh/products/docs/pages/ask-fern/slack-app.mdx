...
<Note>要在您组织的 Slack 工作区中安装 Ask Fern，您必须是 Slack 管理员。</Note>
...
| **roles**      | 指定应使用哪些 RBAC 角色（逗号分隔）来过滤 Ask Fern 响应（如果您已配置[基于角色的访问控制](/learn/docs/authentication/features/rbac)）                    | `/fern roles developer,admin` |
