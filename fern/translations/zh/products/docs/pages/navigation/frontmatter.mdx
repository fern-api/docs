...
<Tip>
  对于超出前置事项选项的高级样式和功能自定义，请参见 [自定义 CSS 和 JavaScript](/learn/docs/customization/custom-css-js)。
</Tip>
...
<ParamField path="tags" type="array of strings" required={false}>
  仅用于 [更新日志页面](/learn/docs/configuration/changelogs)。标签允许用户按特定类别过滤更新日志条目。在前置事项中将标签定义为字符串数组。
</ParamField>
