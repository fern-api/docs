...
sidebar-title: 产品
description: "为多产品文档站点添加产品切换器,每个产品都有自己的导航、标签、版本和 API 参考,同时支持内部和外部产品。"
---
...
<Frame>
  <img src="webflow-dropdown-selector.avif" alt="样式化产品选择器的示例" />
</Frame>
...
<Tabs>
  <Tab title="产品选择器">
    <Frame>
      <img src="webflow-product-selector.avif" alt="样式化产品选择器的示例" />
    </Frame>
  ...
  <Tab title="版本选择器">
    <Frame>
      <img src="webflow-version-selector.avif" alt="样式化版本选择器的示例" />
    </Frame>
  </Tab>
</Tabs>