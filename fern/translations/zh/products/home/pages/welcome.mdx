  ...
  <div className="main-content">
    ...
    <div className="feature-grid">
      ...
      <div className="panel-card ai-search-card">
        <div className="card-header">
          <a className="card-title" href="/cli-generator/get-started/overview">
            CLI generator
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="dark:hidden m-0" noZoom />
            <img src="./images/arrow-right-white.svg" alt="Arrow right light" className="hidden dark:block m-0" noZoom />
          </a>
        ...
        <a href="/cli-generator/get-started/overview" style="cursor: pointer; text-decoration: none;">
          <div class="cli-graphic-container fade-bottom">
            <img src="./images/cli-terminal.png" alt="CLI terminal with tab completion" noZoom />
          </div>
        </a>

        <div className="action-buttons-vertical">
          <a className="fern-button filled normal primary gap-1 w-fit a-btn" href="/cli-generator/get-started/overview">
            介绍
            <img src="./images/arrow-right-white.svg" alt="Arrow right" className="dark:hidden" noZoom />
            <img src="./images/arrow-right-black.svg" alt="Arrow right" className="hidden dark:block" noZoom />
          </a>
          <a className="fern-button minimal normal w-fit gap-1 a-btn" href="/cli-generator/get-started/quickstart">
            快速入门
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="dark:hidden" noZoom />
            <img src="./images/arrow-right-white.svg" alt="Arrow right light" className="hidden dark:block" noZoom />
          </a>
          <a className="fern-button minimal normal w-fit gap-1 a-btn" href="/cli-generator/get-started/features">
            功能
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="dark:hidden" noZoom />
            <img src="./images/arrow-right-white.svg" alt="Arrow right light" className="hidden dark:block" noZoom />
          </a>
...
Generate a CLI from your API definition.

- [Introduction](/cli-generator/get-started/overview)
- [Features](/cli-generator/get-started/features)
- [Quickstart](/cli-generator/get-started/quickstart)
