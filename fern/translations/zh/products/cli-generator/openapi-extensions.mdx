...
CLI 生成器读取多个 [Fern OpenAPI 扩展](/learn/zh/api-definitions/openapi/extensions/overview)来塑造生成的 CLI。您可以直接在规范中添加这些扩展，也可以通过 [overlays](/learn/zh/api-definitions/openapi/overlays) 应用。
...
参见 [SDK 方法名称](/learn/zh/api-definitions/openapi/extensions/method-names)了解更多详情。
...
参见[忽略元素](/learn/zh/api-definitions/openapi/extensions/ignoring-elements)了解更多详情。
...
参见[可用性](/learn/zh/api-definitions/openapi/extensions/availability)了解更多详情。
...
参见[自定义参数名称](/learn/zh/api-definitions/openapi/extensions/parameter-names)了解更多详情。
...
参见[分页](/learn/zh/api-definitions/openapi/extensions/pagination)了解所有支持的分页方案（offset、cursor、URI 和 path）。
