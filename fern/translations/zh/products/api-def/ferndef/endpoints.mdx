...
默认情况下，API 参考中的节名称来自服务文件名（例如，`user.yml` 变成"User"）。要覆盖节的显示名称，[在您的 `docs.yml` 中使用 `section` 属性](/learn/docs/api-references/customize-api-reference-layout#renaming-sections)。
