...
You can add validation rules to your type definitions using the `validation` property. This allows you to enforce constraints on your data model.
...
- `exclusive` - Whether minimum/maximum bounds are inclusive
