...
<CardGroup cols={2}>
  ...
  <Card title="Capabilities" icon="fa-duotone fa-list-check" href="/learn/cli-generator/get-started/capabilities">
    Everything a generated CLI ships with, on one page.
  </Card>
