## 0.26.0
**`(feat):`** Generate OAuth client-credentials authentication from the full Fern IR
...
## 0.25.0
**`(feat):`** The generated CLI now sends a `User-Agent` header identifying itself by its
...
## 0.24.0
**`(feat):`** Includes Rust SDK Generator 0.43.0 updates.
