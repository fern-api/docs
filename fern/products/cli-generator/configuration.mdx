...
<Indent>
<ParamField path="packageIdentity.name" type="string">
...
<ParamField path="packageIdentity.description" type="string">
Short crate description shown on crates.io.
</ParamField>

<ParamField path="packageIdentity.license" type="string">
SPDX license expression, such as `Apache-2.0`.
</ParamField>

<ParamField path="packageIdentity.repository" type="string">
URL of the crate's source repository.
</ParamField>

<ParamField path="packageIdentity.homepage" type="string">
URL of the project homepage.
</ParamField>

<ParamField path="packageIdentity.authors" type="array of strings">
Crate authors, in Cargo's `Name <email>` form.
</ParamField>

<ParamField path="packageIdentity.keywords" type="array of strings">
