...
1. In your OpenAPI spec, list the schemes as [multiple auth schemes](/learn/api-definitions/openapi/authentication#multiple-auth-schemes) in the `security` array.
