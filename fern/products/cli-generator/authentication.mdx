...
The interactive flows are public-client only: they use PKCE rather than a client secret. PKCE always applies to the `authorization-code` flow, with `S256` as the only supported challenge method.
