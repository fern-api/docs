...
OIDC can't perform a package's first publish; npm requires a package to exist before you can add a trusted publisher. Create every package with a placeholder version first.
