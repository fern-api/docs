...
Publish your generated CLI to npm, Homebrew, and GitHub Releases. After following the steps on this page, each tagged release builds cross-platform binaries and publishes them automatically.
...
For details, see npm's [trusted publishing documentation](https://docs.npmjs.com/trusted-publishers).
