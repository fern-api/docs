...
<Prompt title="Generate a CLI">
Help me generate a CLI from my OpenAPI specification with Fern. Follow the [CLI Generator quickstart](https://buildwithfern.com/learn/cli-generator/get-started/quickstart.md) step by step.
</Prompt>
