...
In Go, a page property that lives in the request body rather than in a query parameter requires the [`enableRequestBodyPagination`](/learn/sdks/generators/go/configuration#enablerequestbodypagination) configuration option.
