...
To have every generator fill in the key automatically when a caller omits it, enable [`api.settings.auto-generate-idempotency-key`](/learn/sdks/reference/generators-yml#settingsauto-generate-idempotency-key) in your `generators.yml`.
