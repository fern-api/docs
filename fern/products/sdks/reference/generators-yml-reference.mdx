...
## `metadata`
Package metadata like description and authors that gets included in all generated SDKs. Alternatively, you can [define metadata for individual SDKs](#metadata-1). 
...
Set code reviewers for an individual SDK. Alternatively, you can [configure reviewers globally for all SDKs](#reviewers-1). 
...
Specify which teams and users should review generated code. See [reviewers configuration](#reviewers).
</ParamField>
</Accordion>
