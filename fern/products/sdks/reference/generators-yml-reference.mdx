...
<ParamField path="overrides" type="string | list of strings" toc={true}>
  Path to an AsyncAPI [overrides](/learn/api-definitions/overrides) file, or a list of paths to multiple override files applied sequentially.
...
<ParamField path="overrides" type="string | list of strings" toc={true}>
  Path to an OpenRPC [overrides](/learn/api-definitions/overrides) file, or a list of paths to multiple override files applied sequentially.
