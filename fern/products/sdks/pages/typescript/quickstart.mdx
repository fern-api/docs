...
Generate a TypeScript SDK by following the instructions on this page. <Markdown src="/snippets/release-number.mdx"/>
              ...
              local:
                generators:
                  - name: fernapi/fern-typescript-node-sdk
                    ...
                    version: <Markdown src="/snippets/release-number.mdx"/>
                    config: 
