...
<Step title="Set up your coding agent">
  Connect [Fern's MCP server](/learn/docs/ai-features/mcp-server) so the agent can look up SDK configuration and behavior from Fern SDK documentation instead of guessing.
