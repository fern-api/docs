...
<Step title="Set up your coding agent">
  Working with a coding agent is optional. Registering [Fern's documentation MCP server](/learn/docs/ai-features/fern-mcp-servers) lets it look up generator configuration and API definition syntax as it works. In Claude Code:
