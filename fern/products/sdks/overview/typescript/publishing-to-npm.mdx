...
## Release using GitHub workflows (optional, recommended)

Update your release workflow to use GitHub Actions Add a GitHub action to trigger SDK releases for each language. Trigger new releases directly from your repo instead of your local machine. 

-add NPM Token to GitHub
-Add Fern token to GitHub

In your repo, navigate to Actions and select New workflow, then Set up workflow yourself. Set up a workflow dispatch that is similar to this:
...
Navigate to Actions tab and click run workflow
