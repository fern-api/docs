...
<ParamField path="extraHeaders" type="object" toc={true}>
...
<ParamField path="sdkVariableHeaders" type="object" toc={true}>
...
<ParamField path="options.extensions" type="object" required={false}>
