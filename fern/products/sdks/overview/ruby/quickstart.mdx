...
<Markdown src="/products/sdks/snippets/setup-github-repos.mdx" language="ruby" groupName="ruby-sdk" generatorName="ruby" version={<Markdown src="/snippets/version-number-ruby.mdx"/>} />
