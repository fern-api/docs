...
<Markdown src="/products/sdks/snippets/setup-github-repos.mdx" language="rust" groupName="rust-sdk" generatorName="rust" version={<Markdown src="/snippets/version-number-rust.mdx"/>} />
