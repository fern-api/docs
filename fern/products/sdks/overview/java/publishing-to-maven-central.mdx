...
registry](https://central.sonatype.com/). After following the steps on this page,
...
<Steps>
  ...
  1. Enter your namespace in reverse domain name format and go through the
     verification process. Your verified namespace must match the namespace you
     specified in the `coordinate` field. 
