...
<Markdown src="/products/sdks/snippets/setup-github-repos.mdx" language="java" groupName="java-sdk" generatorName="java" version={<Markdown src="/snippets/version-number-java.mdx"/>} />
