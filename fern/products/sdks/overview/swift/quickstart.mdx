...
<Markdown src="/products/sdks/snippets/setup-github-repos.mdx" language="swift" groupName="swift-sdk" generatorName="swift" />
    ...
    generators:
      - name: fernapi/fern-swift-sdk
        ...
        output:
          ...
          path: ../sdks/swift
        github:
          repository: your-org/your-api-swift-sdk
```
