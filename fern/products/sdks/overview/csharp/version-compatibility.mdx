...
Unity compiles projects using Roslyn, typically supporting C# 9 (varies by Unity version). You cannot force Unity to use a newer C# compiler by changing your package because Unity controls the compiler inside the Editor.
</Accordion>
...
<Accordion title="Type or namespace IsExternalInit not found">
  Add the shim shown above or include a package that provides it.
</Accordion>
