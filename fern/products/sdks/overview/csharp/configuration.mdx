...
When enabled, generates mock server tests that run your SDK against a mock server generated from your API definition. These tests verify that the SDK sends HTTP requests and receives HTTP responses as expected.
</ParamField>
