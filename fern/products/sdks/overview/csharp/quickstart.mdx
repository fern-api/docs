...
<Markdown src="/products/sdks/snippets/setup-github-repos.mdx" language="csharp" groupName="csharp-sdk" generatorName="csharp" />
    ...
    generators:
      - name: fernapi/fern-csharp-sdk
        ...
        output:
          ...
          path: ../sdks/csharp
        github:
          repository: your-org/your-api-csharp-sdk
```
