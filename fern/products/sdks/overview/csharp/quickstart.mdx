  ...
  <Folder name="sdks" defaultOpen>
    <Folder name="csharp" defaultOpen>
      <Folder name="src" defaultOpen>
        ...
        <Folder name="YourOrganizationApi.Test">
          <Folder name="Utils" />
          <Folder name="Core" />
        </Folder>
      </Folder>
...
Note: The `fern` folder is created by `fern init`, the `sdks` folder is created by `fern generate --group csharp-sdk`, and the `Imdb` folder is named after your API.
</Steps>
