...
<Markdown src="/products/sdks/snippets/setup-github-repos.mdx" language="csharp" groupName="csharp-sdk" generatorName="csharp" version={<Markdown src="/snippets/version-number-csharp.mdx"/>} />
