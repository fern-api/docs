...
<Markdown src="/products/sdks/snippets/setup-github-repos.mdx" language="python" groupName="python-sdk" generatorName="python" version={<Markdown src="/snippets/version-number-python.mdx"/>} />
