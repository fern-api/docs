...
<Steps>
	...
	<Step title="Run `fern add <generator>`">
	  ...
	  Remove the auto-generated `output`, `location`, and `path` fields. Instead, add the path to your GitHub repository: 
...
<Steps>
	...
	Regenerate your SDK and publish it on Packagist:
