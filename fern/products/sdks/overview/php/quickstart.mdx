...
<Markdown src="/products/sdks/snippets/setup-github-repos.mdx" language="php" groupName="php-sdk" generatorName="php" version={<Markdown src="/snippets/version-number-php.mdx"/>} />
