...
If you're generating SDKs with an AI coding agent, connect [Fern's MCP server](/learn/docs/ai-features/mcp-server) so the agent can look up SDK configuration and behavior from Fern's docs instead of guessing:
