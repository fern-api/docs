...
Now that you have a working SDK, follow the guide for your target language to set up GitHub repositories, configure publishing, and more.

<CardGroup cols={3}>
  <Card title="TypeScript" icon="brands js" href="/learn/sdks/generators/typescript/quickstart">
  ...
  <Card title="How it works" icon="regular gears" href="/learn/sdks/how-it-works">
