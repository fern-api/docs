...
<Prompt title="Generate a Rust SDK">
Help me generate a Rust SDK with Fern. Follow the [Rust SDK quickstart](https://buildwithfern.com/learn/sdks/generators/rust/quickstart.md) step by step.
</Prompt>
