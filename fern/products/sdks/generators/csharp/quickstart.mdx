...
<Prompt title="Generate a .NET SDK">
Help me generate a .NET SDK with Fern. Follow the [.NET SDK quickstart](https://buildwithfern.com/learn/sdks/generators/csharp/quickstart.md) step by step.
</Prompt>
