...
<ParamField path="default-timeout-in-seconds" type="number | 'infinity'" default="30" required={false} deprecated={true} toc={true}>
Deprecated. Use [`default-timeout-in-milliseconds`](#default-timeout-in-milliseconds) instead.
</ParamField>
