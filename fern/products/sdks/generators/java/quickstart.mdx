...
<Prompt title="Generate a Java SDK">
Help me generate a Java SDK with Fern. Follow the [Java SDK quickstart](https://buildwithfern.com/learn/sdks/generators/java/quickstart.md) step by step.
</Prompt>
