...
Developers using your SDK register interceptors as they construct the client. Each call to `addInterceptor` adds to the set, and all are applied to the underlying `OkHttpClient` at build time:
