...
<Prompt title="Generate a Go SDK">
Help me generate a Go SDK with Fern. Follow the [Go SDK quickstart](https://buildwithfern.com/learn/sdks/generators/go/quickstart.md) step by step.
</Prompt>
