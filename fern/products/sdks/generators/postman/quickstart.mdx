...
<Prompt title="Import an API into Postman">
Help me import my OpenAPI specification into Postman. Follow [Postman's OpenAPI import documentation](https://learning.postman.com/docs/integrations/available-integrations/working-with-openAPI/) step by step.
</Prompt>
