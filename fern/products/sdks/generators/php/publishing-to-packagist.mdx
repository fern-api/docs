...
<Info>
	...
	* An initialized `fern` folder, a GitHub repository for your PHP SDK, and a PHP generator group in `generators.yml`. See [Generating an SDK (PHP)](/learn/sdks/generators/php/quickstart).
</Info>
