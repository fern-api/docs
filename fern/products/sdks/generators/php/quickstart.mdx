...
<Prompt title="Generate a PHP SDK">
Help me generate a PHP SDK with Fern. Follow the [PHP SDK quickstart](https://buildwithfern.com/learn/sdks/generators/php/quickstart.md) step by step.
</Prompt>
