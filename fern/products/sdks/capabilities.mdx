...
<CardGroup cols={3}>
  ...
  <Card title="Server-sent events" icon="fa-duotone fa-broadcast-tower" href="/learn/sdks/deep-dives/sdk-user-features#server-sent-events">
...
- **Server-sent events**: Stream JSON data from your server to your client, with opt-in access to server-sent event (SSE) metadata (event ID, event type, retry). [Learn more](/learn/sdks/deep-dives/sdk-user-features#server-sent-events)
...
- **WebSockets**: Send and receive messages over WebSockets. [Learn more](/api-definitions/ferndef/websockets)
</llms-only>
