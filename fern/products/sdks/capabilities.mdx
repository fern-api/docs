...
<CardGroup cols={3}>
  ...
  <Card title="Automated releases" icon="fa-duotone fa-box" href="/learn/sdks/overview/autopilot">
    Fern Autopilot automatically detects API changes, regenerates SDKs, and publishes to registries.
