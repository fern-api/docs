...
<Files>
  <Folder name="company-repo" defaultOpen>
    ...
    <Folder name="typescript-sdk-repo" defaultOpen>
      <Folder name=".github">
...
- **fern/apis/sdks/generators.yml**: Contains settings for all SDKs
- **typescript-sdk-repo**: Repository for a TypeScript SDK with its own `.fernignore`
- **python-sdk-repo**: Repository for a Python SDK with its own `.fernignore`
