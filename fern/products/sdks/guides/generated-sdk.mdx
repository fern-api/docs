...
Users install SDKs using standard package managers from language-specific registries (npm for TypeScript, PyPI for Python, etc.). 
...
| Retries | Configure maximum retries (default: 2 with exponential backoff for 408, 429, and 5xx responses) | All languages except Ruby and Swift |
