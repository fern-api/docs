...
Fern-generated SDKs include full type definitions that enable rich IDE support. When developers use your SDK in editors like VS Code, they get autocomplete suggestions, inline documentation, and type information for all methods and parameters.

<video autoPlay loop muted playsInline>
  <source src="./intellisense-demo.mp4" type="video/mp4" />
</video>

![IDE intellisense showing method signature and return type](./intellisense-screenshot.png)

This inline documentation comes directly from your API definition. When you provide descriptions for endpoints, parameters, and types in your OpenAPI spec or Fern Definition, Fern carries that text into the generated SDK as JSDoc comments (for TypeScript/JavaScript) or equivalent documentation annotations in other languages. This means your SDK users can discover available methods, understand parameter requirements, and see return types without leaving their editor or consulting external documentation.
