...
When you define webhooks in your API spec, Fern automatically generates utilities that allow your users to verify webhook signatures and ensure events originate from your API. For configuration details, see [Webhook signature verification](./webhook-signature-verification).
