...
Mock server tests are available for TypeScript, Go, Java, Swift, Python, PHP, Rust, and C#. Configure mock server tests in your `generators.yml`:
...
| Java | [`enable-wire-tests`](/learn/sdks/generators/java/configuration#enablewiretests) | false |
...
| Rust | `enableWireTests` | false |
| C# | [`generate-mock-server-tests`](/learn/sdks/generators/csharp/configuration#generate-mock-server-tests) | true |
