...
Configuring audiences in an [OpenAPI spec](/learn/api-definitions/openapi/extensions/audiences) involves:
...
Configuring audiences in a [Fern Definition](/learn/api-definitions/ferndef/audiences) involves:
