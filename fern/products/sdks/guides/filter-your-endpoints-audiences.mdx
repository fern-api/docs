...
<Tip>
For path-based filtering instead of tag-based filtering, use [`settings.filter`](/learn/sdks/reference/generators-yml#openapi) in your OpenAPI spec settings.
</Tip>
...
1. Marking your API elements with audience tags. For detailed syntax, see [audiences in OpenAPI](/learn/api-definitions/openapi/extensions/audiences) or [audiences in Fern Definition](/learn/api-definitions/ferndef/audiences).
