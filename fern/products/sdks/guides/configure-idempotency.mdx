...
Configure [idempotency headers in `api.yml`](/learn/api-definitions/ferndef/api-yml/global-headers#idempotency-headers), then [mark individual endpoints as idempotent](/learn/api-definitions/ferndef/endpoints/overview#idempotent-endpoints):
