...
Configure idempotency headers using the [`x-fern-idempotency-headers`](/api-definitions/openapi/extensions/idempotency-headers) extension and mark endpoints as idempotent using the [`x-fern-idempotent`](/api-definitions/openapi/extensions/idempotent-endpoints) extension:
