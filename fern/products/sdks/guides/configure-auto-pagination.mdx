...
Annotate the desired paginated endpoint with the `x-fern-pagination` extension, specify the pagination scheme, and indicate where your results are located:
...
Annotate the desired paginated endpoint with the `pagination` field, specify the pagination scheme, and indicate where your results are located:
...
<CardGroup cols={2}>
  <Card title="OpenAPI" href="/learn/api-definitions/openapi/extensions/pagination">
    Configure the `x-fern-pagination` extension with full property reference
  </Card>
  <Card title="Fern Definition" href="/learn/api-definitions/ferndef/endpoints/overview#pagination">
    Configure the `pagination` field with full property reference
  </Card>
</CardGroup>
