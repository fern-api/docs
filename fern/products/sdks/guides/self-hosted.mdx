...
<Tip>
The underlying SDK generation architecture is the same whether you use cloud or self-hosted generation. See this [complete SDK generation architecture diagram](/learn/sdks/overview/how-it-works#sdk-generation-architecture) for details.
</Tip>
