...
<ParamField path="jwks-url" type="string" required={false} toc={true}>
  JWKS endpoint URL for key retrieval. Required when using JWKS-based key rotation; omit for static key verification.
</ParamField>
