  ...
  <CardGroup cols={2}>
    <a class="fern-card interactive not-prose relative block p-6 text-base" href="/docs/guides/getting-started/quickstart">
      <div class="flex items-start flex-col space-y-3">
        ...
        <img class="mx-auto hidden dark:block" alt="TypeScript" src="./guides/images/typescript-card.png" />
    ...
    <a class="fern-card interactive not-prose relative block p-6 text-base" href="/docs/guides/getting-started/python">
      <div class="flex items-start flex-col space-y-3">
        ...
        <img class="mx-auto hidden dark:block" alt="Python" src="./images/python-card.png" />
        <div class="w-full space-y-1 overflow-hidden">
          <div class="text-(color:--grayscale-a12) text-body text-base font-semibold card-title">
            Python
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="arrow-right dark:hidden m-0" noZoom />
    ...
    <a class="fern-card interactive not-prose relative block p-6 text-base" href="/docs/guides/getting-started/go">
      <div class="flex items-start flex-col space-y-3">
        ...
        <img class="mx-auto hidden dark:block" alt="Go" src="./images/go-card.png" />
        <div class="w-full space-y-1 overflow-hidden">
          <div class="text-(color:--grayscale-a12) text-body text-base font-semibold card-title">
            Go
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="arrow-right dark:hidden m-0" noZoom />
    ...
    <a class="fern-card interactive not-prose relative block p-6 text-base" href="/docs/guides/getting-started/java">
      <div class="flex items-start flex-col space-y-3">
        ...
        <img class="mx-auto hidden dark:block" alt="Java" src="./images/java-card.png" />
        <div class="w-full space-y-1 overflow-hidden">
          <div class="text-(color:--grayscale-a12) text-body text-base font-semibold card-title">
            Java
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="arrow-right dark:hidden m-0" noZoom />
    ...
    <a class="fern-card interactive not-prose relative block p-6 text-base" href="/docs/guides/getting-started/dotnet">
      <div class="flex items-start flex-col space-y-3">
        ...
        <img class="mx-auto hidden dark:block" alt=".NET" src="./images/csharp-card.png" />
        <div class="w-full space-y-1 overflow-hidden">
          <div class="text-(color:--grayscale-a12) text-body text-base font-semibold card-title">
            .NET
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="arrow-right dark:hidden m-0" noZoom />
    ...
    <a class="fern-card interactive not-prose relative block p-6 text-base" href="/docs/guides/getting-started/php">
      <div class="flex items-start flex-col space-y-3">
        ...
        <img class="mx-auto hidden dark:block" alt="PHP" src="./images/php-card.png" />
        <div class="w-full space-y-1 overflow-hidden">
          <div class="text-(color:--grayscale-a12) text-body text-base font-semibold card-title">
            PHP
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="arrow-right dark:hidden m-0" noZoom />
    ...
    <a class="fern-card interactive not-prose relative block p-6 text-base" href="/docs/guides/getting-started/ruby">
      <div class="flex items-start flex-col space-y-3">
        <img class="mx-auto dark:hidden" alt="Ruby" src="./guides/images/ruby-card.png" />
        <img class="mx-auto hidden dark:block" alt="Ruby" src="./guides/images/ruby-card.png" />
        <div class="w-full space-y-1 overflow-hidden">
          <div class="text-(color:--grayscale-a12) text-body text-base font-semibold card-title">
            Ruby
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="arrow-right dark:hidden m-0" noZoom />
    ...
    <a class="fern-card interactive not-prose relative block p-6 text-base" href="/docs/guides/getting-started/mcp">
      <div class="flex items-start flex-col space-y-3">
        ...
        <img class="mx-auto hidden dark:block" alt="MCP Server" src="./images/mcp-card.png" />
        <div class="w-full space-y-1 overflow-hidden">
          <div class="text-(color:--grayscale-a12) text-body text-base font-semibold card-title">
            MCP Server
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="arrow-right dark:hidden m-0" noZoom />
    ...
    <a class="fern-card interactive not-prose relative block p-6 text-base" href="/docs/guides/getting-started/rust">
      <div class="flex items-start flex-col space-y-3">
        ...
        <img class="mx-auto hidden dark:block" alt="Request Rust" src="./images/rust-card.png" />
        <div class="w-full space-y-1 overflow-hidden">
          <div class="text-(color:--grayscale-a12) text-body text-base font-semibold card-title">
            Request Rust
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="arrow-right dark:hidden m-0" noZoom />
    ...
    <a class="fern-card interactive not-prose relative block p-6 text-base" href="/docs/guides/getting-started/swift">
      <div class="flex items-start flex-col space-y-3">
        ...
        <img class="mx-auto hidden dark:block" alt="Request Swift" src="./images/swift-card.png" />
        <div class="w-full space-y-1 overflow-hidden">
          <div class="text-(color:--grayscale-a12) text-body text-base font-semibold card-title">
            Request Swift
            <img src="./images/arrow-right-black.svg" alt="Arrow right light" className="arrow-right dark:hidden m-0" noZoom />
