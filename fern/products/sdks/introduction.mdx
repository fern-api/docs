...
{/* Dashed Pattern - Left Side */}
  ...
  <Card title="SDK snippets" icon="fa-duotone fa-brackets-curly" href="/docs/api-references/sdk-snippets">
    Automatically generate SDK code snippets for your API Reference. When you use Fern's SDK Generator, code examples in TypeScript, Python, Go, Java, and more are generated from your API definition and displayed in a language selector dropdown.
