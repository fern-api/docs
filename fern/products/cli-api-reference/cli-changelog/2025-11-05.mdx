...
## 0.107.8
**`(feat):`** Add support for x-fern-playground-enabled extension in OpenAPI v3 to control whether endpoints are shown in the API playground. The extension value is parsed and stored in the IR's HttpEndpoint.apiPlayground field. This extension was later renamed to x-fern-explorer in version 0.120.0.
