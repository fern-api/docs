...
## 0.119.1
**`(feat):`** Add x-fern-playground extension to OpenAPI importer to control API playground visibility. Defaults to true. This extension was later renamed to x-fern-explorer in version 0.120.0.
