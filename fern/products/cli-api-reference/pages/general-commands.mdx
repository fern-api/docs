...
<AccordionGroup>
  ...
  <Accordion title="fern token">
    ...
    See [Publishing your docs](/learn/docs/preview-publish/publishing-your-docs#publish-to-production) for instructions on using this API key in automated publishing workflows. 
