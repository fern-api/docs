...
<AccordionGroup>
  ...
  <Accordion title="fern generate">
    ...
    Use `--fernignore` to specify a custom `.fernignore` file to use during remote generation. Fern will use this file instead of the one on the main branch and commit the new `.fernignore` to your repository as part of the generation process.
