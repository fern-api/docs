...
<AccordionGroup>
  ...
  <Accordion title="fern docs md check">
    ...
    Use `fern docs md check` to validate MDX syntax across all documentation pages referenced in your `docs.yml`. The command parses each MDX file and reports syntax errors with file paths and line:column numbers.
