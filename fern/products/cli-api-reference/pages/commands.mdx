...
<AccordionGroup>
  ...
  <Accordion title="fern generate">
    ...
    You can also use `--group` with an alias name to run multiple groups in parallel. Aliases are [defined in your `generators.yml`](/learn/sdks/reference/generators-yml#aliases).
