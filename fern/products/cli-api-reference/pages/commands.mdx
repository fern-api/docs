...
<AccordionGroup>
  ...
  <Accordion title="fern generate">
    ...
    Omitting `--version` makes Fern [compute the next version itself](/learn/sdks/overview/how-it-works#version-numbers), and `--version AUTO` derives the bump from the SDK output diff.
