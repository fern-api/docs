...
<AccordionGroup>
  ...
  <Accordion title="fern docs md generate">
    ...
    Use `fern docs md generate` to generate MDX documentation pages from your library source code. The command reads [`libraries`](/learn/docs/api-references/library-reference) entries in `docs.yml` and produces pages for modules, classes, functions, and types.
    ...
    <Info>
    For full setup instructions, configuration options, and examples, see the [Library docs generator](/learn/docs/api-references/library-reference) page.
    </Info>
