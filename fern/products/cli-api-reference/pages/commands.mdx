...
<AccordionGroup>
  ...
  <Accordion title="fern docs preview delete">
    ...
    Use `fern docs preview delete` to delete a preview deployment. This allows you to clean up preview sites that were generated with `fern generate --docs --preview`.
    ...
    The `<url>` argument is the full preview URL to delete.
