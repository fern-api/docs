...
<AccordionGroup>
  ...
  <Accordion title="fern check">
    ...
    <Note>
    For comprehensive link checking, use the [broken link checker in the Fern Dashboard](/learn/docs/preview-publish/publishing-your-docs#check-for-broken-links), which validates both internal and external links on your live published site.
    </Note>
