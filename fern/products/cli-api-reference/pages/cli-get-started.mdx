...
<Prompt title="Get started with Fern CLI">
Help me install and use the Fern CLI. Follow the [Fern CLI guide](https://buildwithfern.com/learn/cli-api-reference/cli-reference/overview.md) step by step.
</Prompt>
