...
<Tabs>
  ...
  Requires [Node.js](https://nodejs.org/) version 22 or higher and npm version 10.0.0 or higher (ships with Node.js 22). If your version is below the minimum, [download Node.js 22 or higher](https://nodejs.org/).
