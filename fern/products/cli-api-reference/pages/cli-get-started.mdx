...
Most users install Fern globally with the commands above. Install it locally instead to pin its version per project or to work in an environment with limited internet connectivity.
