...
Once Fern configures the connection, select **Connect repo** in the **Source** section of the **Overview** tab and choose your repository. Editor changes on GitLab arrive as merge requests.
</Step>
</Steps>
