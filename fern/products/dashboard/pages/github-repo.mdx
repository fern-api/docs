...
GitLab repositories connect through the same **Source** section, but Fern configures the access token for you first. See [GitLab setup](/learn/docs/writing-content/fern-editor#getting-started) for the token scopes to send to support.
