...
The Dashboard automatically provides the correct DNS records based on your domain type. It verifies one custom domain per docs site; to serve [additional domains or aliases](/learn/docs/preview-publish/setting-up-your-domain#multiple-custom-domains), contact Fern to register and verify each one.
