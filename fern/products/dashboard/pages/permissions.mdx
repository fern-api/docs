...
When a teammate logs in to their organization via the Dashboard or CLI, they are assigned an Admin, Editor, or Viewer role. By default, all teammates have Admin permissions unless a different role has been assigned. 
