...
<Warning title="Enterprise feature">
    Every plan lets you add members up to its [member limit](#team-members-by-plan). Assigning Editor or Viewer roles requires the [Enterprise plan](https://buildwithfern.com/pricing). To get started, reach out to support@buildwithfern.com.
</Warning>
