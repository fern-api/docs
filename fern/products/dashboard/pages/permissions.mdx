...
Members of your team are assigned an Admin, Editor, or Viewer role, which controls their Dashboard and CLI access. By default, all members have Admin permissions unless a different role has been assigned. 
...
Admins have full access to both the Dashboard and CLI, including editing organization settings, managing members, using [Fern Editor](/learn/docs/writing-content/fern-editor), and publishing to production.
