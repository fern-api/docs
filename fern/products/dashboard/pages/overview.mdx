...
<CardGroup cols={2}>
  ...
  >
    Configure default path and search scope for domains shared across multiple
    repositories.
  </Card>
</CardGroup>
...
- [Enable Ask AI](/learn/docs/ai-features/ask-ai/overview): Set up AI-powered chat for your documentation.
...
- [Ask AI conversations](/learn/docs/ai-features/ask-ai/overview): Review AI chat conversation history.
