...
<CardGroup cols={2}>
  ...
  <Card
    title="Fern tokens"
    icon="regular key"
    href="/learn/dashboard/configuration/fern-tokens"
  >
    Create and manage tokens for CLI authentication in CI/CD.
  </Card>
  <Card
...
- [Fern tokens](/learn/dashboard/configuration/fern-tokens): Create and manage tokens for CLI authentication in CI/CD.
