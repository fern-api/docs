...
<CardGroup cols={2}>
  ...
  <Card
    title="API tokens"
    icon="regular key"
    href="/learn/dashboard/configuration/api-tokens"
  >
...
- [API tokens](/learn/dashboard/configuration/api-tokens): Create and manage tokens for CLI authentication in CI/CD.
