...
Enter a single password for your entire set, or multiple passwords that are each mapped to a user role. Click **Save** and select **Enable** to activate password protection.
...
If you set up multiple passwords with different roles, configure [role-based access control (RBAC)](/learn/docs/authentication/features/rbac) in `docs.yml` to restrict pages and sections of your site by role.
</Step>
</Steps>
