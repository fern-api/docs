...
To translate navigation items, create a matching file under `fern/translations/{locale}/` for any base config YAML you have — `docs.yml`, product files, [version files](/learn/docs/configuration/versions). Include only the fields you want to translate; everything else falls back to the default language. [Example PR](https://github.com/fern-api/docs/pull/5203/files)
