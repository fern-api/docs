...
description: "Ship documentation in multiple languages from a single source. Fern auto-translates your default-language pages on each build, with per-locale URLs and a header language switcher."
---
