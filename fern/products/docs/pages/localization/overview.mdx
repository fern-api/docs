...
Fern lets you publish your documentation in multiple languages from a single source. Readers switch languages from a dropdown in your site header, search is indexed per language, and each locale gets its own indexable URL for SEO.
