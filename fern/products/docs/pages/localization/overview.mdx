...
You supply the translations — Fern handles the rest. It renders a language switcher in the header, scopes each locale to its own URL path, and falls back to the default language for any page you haven't translated yet.
