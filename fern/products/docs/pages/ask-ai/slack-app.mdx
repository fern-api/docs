...
Ask A Iis available as a Slack app called **Ask Fern**. The app lets customers ask questions about your products directly in Slack channels and receive AI-generated answers from your documentation database.

Fern stores all questions and answers from Slack interactions for [analytics purposes](/learn/docs/ai-features/ask-ai/overview#analytics).
...
<Note>
  To install Ask Fern in your organization's Slack workspace, you must be a Slack
  admin.
</Note>
...
Use the [API Explorer](/learn/docs/ai-features/ask-ai/api-reference/slack-ask-fern/get-slack-install-link) to get a unique Slack installation link for your organization. Provide:
