...
The Fern Dashboard verifies one custom domain per docs site. To serve your documentation from additional domains or aliases (e.g., for partner or white-label deployments), list them as an array in your `docs.yml`:
