...
<Frame caption="Browse the [live site](https://multi-source.docs.buildwithfern.com) or the [source on GitHub](https://github.com/fern-api/docs-examples/tree/main/multi-source).">
  <iframe
    src="https://multi-source.docs.buildwithfern.com?embedded=true"
    style="width: 100%; height: 500px; border: none; border-radius: 8px;"
    title="Multi-source docs example"
  />
</Frame>
