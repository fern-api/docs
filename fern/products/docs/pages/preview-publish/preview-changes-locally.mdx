...
Broken internal links fail by default. Use [`fern generate --docs --no-strict-broken-links`](/learn/cli-api-reference/cli-reference/sdk-commands#fern-generate) to downgrade the failure to a warning while you fix them.
