...
Talk to it in the [Fern Dashboard](https://dashboard.buildwithfern.com/) chat panel, or [integrate](#setup) it with your Slack or your coding agent (via MCP) in one click.
