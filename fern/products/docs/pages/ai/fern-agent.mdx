...
Use it in three places: a chat panel in [Fern Dashboard](https://dashboard.buildwithfern.com/), [Slack](#setup), and [your coding agent over MCP](/learn/docs/ai-features/fern-mcp-servers#your-organizations-server). All three connect from the dashboard chat panel, and it acts with your own permissions in each, so it reads and edits only the docs sites you already have access to.
