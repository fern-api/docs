...
Using AI, Fern automatically creates request and response examples that contain believable data based on your OpenAPI specs. Where Fern previously showed placeholder text like `username: "string"` and `price: 1.1`, it shows examples that make sense given your endpoint properties and descriptions. These examples stay up to date with your changing spec - if you change or add a field, your generated examples will keep up.
