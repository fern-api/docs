...
<Tip>
To make AI-generated examples portable to non-Fern OpenAPI tools, use [`fern api enrich`](/learn/cli-api-reference/cli-reference/sdk-commands#fern-api-enrich) to merge them into native OpenAPI example fields.
</Tip>
