...
<Tip>
To make AI-generated examples portable to non-Fern OpenAPI tools, use [`fern api enrich`](/learn/cli-api-reference/cli-reference/general-commands#fern-api-enrich) to merge them into native OpenAPI example fields.
</Tip>

## Disable AI-generated examples

To turn the feature off entirely, set `enabled` to `false`:
