...
Each message sent through the MCP server runs Ask Fern under the hood and consumes 2 [AI credits](/learn/docs/ai-features/overview#ai-credits), the same as a message in the Ask Fern panel.
