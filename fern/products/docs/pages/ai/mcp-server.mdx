...
When you have [AI search (Ask Fern)](/learn/docs/ai-features/ask-fern/overview) enabled on your site, Fern automatically generates and hosts a production-ready MCP server. This enables developers using AI clients (like Claude Desktop, Cursor, and Windsurf) to get instant answers about your product directly within their development environment.
