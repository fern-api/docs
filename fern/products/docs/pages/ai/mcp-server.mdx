...
<Tabs>
  <Tab title="API key (JWT / OAuth)">
    Exchange a [Fern API key](/learn/cli-api-reference/cli-reference/sdk-commands#fern-token) for a JWT via the [get-jwt endpoint](/learn/docs/fern-api-reference/get-jwt):
