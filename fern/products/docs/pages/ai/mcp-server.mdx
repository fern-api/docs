...
<Note>
The MCP server requires [Ask AI](/learn/docs/ai-features/ask-fern/overview) to be enabled on your site. If Ask AI is not enabled, the MCP server will not return results.
</Note>
