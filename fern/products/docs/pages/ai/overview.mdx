...
Fern Writer is a technical writing agent powered by Devin AI available in beta. Tag `@Fern Writer` in Slack to request documentation updates, and it drafts targeted edits via GitHub pull requests. Fern Writer learns your writing style and adapts to your team's workflow.
