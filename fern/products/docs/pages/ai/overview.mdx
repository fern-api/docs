...
Fern doesn't use your documentation content, your code, or your end users' queries to train AI models. Each feature page documents what it sends to a model and what Fern stores: [Ask Fern](/learn/docs/ai-features/ask-fern/overview#privacy-and-data-handling), [AI-generated examples](/learn/docs/ai-features/ai-examples), and [Fern Agent](/learn/docs/ai-features/fern-agent#privacy-and-data-handling).
