...
Request changes by commenting in the Slack thread. Fern Writer responds to feedback from both humans and automated review tools. Once the PR meets your requirements, merge it like any other pull request.

<Note>
Fern Writer doesn't respond to comments left directly on pull requests. To request changes, comment in the original Slack thread instead.
</Note>
...
Fern Writer requires GitHub. GitLab and other Git providers aren't supported.
