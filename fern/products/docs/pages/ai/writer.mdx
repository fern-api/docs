...
Install the [Fern GitHub App](https://github.com/apps/fern-api) on the repository containing your documentation. The app requires admin access to the GitHub organization. This grants Fern Writer the permissions it needs to:

- Read pull requests and source code changes in your repository
- Create pull requests with documentation updates
- Push commits attributed to `fern-support`

If you've already connected a GitHub repository through the [Fern Dashboard](/learn/dashboard/configuration/github-repo), the app is already installed.
