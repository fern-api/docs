...
Neither Fern nor Cognition (the maker of Devin) uses your data to train AI models. Fern explicitly configures its Devin integration to opt out of any data collection for model training. Your channel messages, code, and documentation content are never used for training purposes.

For more details, see:
- [Devin security and data handling](https://docs.devin.ai/admin/security#how-is-your-data-used-to-improve-devin)
- [Devin Slack integration security](https://docs.devin.ai/admin/security#integrating-with-slack)
- [Fern Trust Center](https://security.buildwithfern.com/)
