...
Fern hosts two [Model Context Protocol (MCP)](https://modelcontextprotocol.io) servers for your coding agent to use while you build your docs: a public, read-only one for Fern's product documentation, and a private one for your organization's Fern data that also exposes [Fern Agent](/learn/docs/ai-features/fern-agent).
