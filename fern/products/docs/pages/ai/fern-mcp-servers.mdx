...
Open the [Fern Dashboard](https://dashboard.buildwithfern.com/). From the Fern Agent chat panel, click **Onboard your agent** to connect your coding agent to the MCP server. 
