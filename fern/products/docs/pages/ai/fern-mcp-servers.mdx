...
Alternatively, you can set it up directly from your terminal (the [MCP quickstart](/learn/docs/ai-features/fern-mcp-quickstart) walks through this step by step):
