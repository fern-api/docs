...
- Beyond that pairing, `<llms-only>` suits verbose technical context that would clutter the human UI, such as implementation details, architecture notes, or cross-references that help AI understand relationships between pages.
