...
`llms.txt` is generated automatically for your site, but discovery is up to you. Track usage in the [Web Analytics tab](/learn/dashboard/metrics/web-analytics) and surface endpoints directly in your docs.
