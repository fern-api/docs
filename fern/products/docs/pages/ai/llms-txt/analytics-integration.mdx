...
`llms.txt` is generated automatically for your site, but discovery is up to you. Track usage in the [web analytics dashboard](/learn/dashboard/metrics/web-analytics) and surface endpoints directly in your docs.

## Track AI traffic

The web analytics dashboard provides analytics for `llms.txt` usage including:
