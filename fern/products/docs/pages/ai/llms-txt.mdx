...
- Internal comments that shouldn't appear in the copy button or "View as Markdown" output
...
Internal comments in MDX files are exposed when users click the copy button or "View as Markdown" page action. Wrap comments in `<llms-ignore>` to keep them visible only in your source files:

```jsx docs/api-reference.mdx
<llms-ignore>
{/* TODO: Update this section after v2 launch */}
{/* Internal note: This endpoint is deprecated but kept for backwards compatibility */}
</llms-ignore>
```
