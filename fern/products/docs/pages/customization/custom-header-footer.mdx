...
| `<Fern.SiteSwitcher />` | Dropdown to switch between sibling docs sites published under different basepaths on the same host. Renders nothing when the site has no siblings. |
