...
Customize the color palette for your documentation site, including accent colors, backgrounds, borders, and component-specific colors for light and dark modes.
