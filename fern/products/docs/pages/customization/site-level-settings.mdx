...
Configure visual theming options for your documentation site.
...
<ParamField path="theme.page-actions" type="string" required={false} toc={true}>
  Controls the display style of page action buttons. 
  
  Set to `toolbar` to display page actions in a toolbar format.
</ParamField>
