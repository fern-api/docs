...
<ParamField path="settings.default-search-filters" type="boolean" required={false} default="false" toc={true}>
  ...
  If set to true, search results are automatically filtered to the product and version the user is browsing. Users can manually remove the filter from the search UI to search across all products and versions. This setting is useful for multi-product sites where users typically want results scoped to the product they're viewing.
</ParamField>
