...
<ParamField path="favicon" type="string" required={false} toc={true}>
  Relative filepath to the favicon. The path is relative to the configuration file where it's set.
</ParamField>
...
<ParamField path="logo.dark" type="string" required={false} toc={true}>
  Path to your dark mode logo file, relative to the configuration file where it's set. SVG format is recommended for optimal quality. Example: `assets/images/logo-dark.svg`
</ParamField>

<ParamField path="logo.light" type="string" required={false} toc={true}>
  Path to your light mode logo file, relative to the configuration file where it's set. SVG format is recommended for optimal quality. Example: `assets/images/logo-light.svg`
</ParamField>
...
<ParamField path="background-image.light" type="string" required={false} toc={true}>
  Relative filepath to the light-mode background image. The path is relative to the configuration file where it's set.
</ParamField>

<ParamField path="background-image.dark" type="string" required={false} toc={true}>
  Relative filepath to the dark-mode background image. The path is relative to the configuration file where it's set.
</ParamField>
...
<ParamField path="path" type="string" required={false} toc={true}>
  The path to your font file, relative to the configuration file where it's set. Use this when you have a single font file. For multiple font files (like separate files for bold, italic etc), use `paths` instead.
</ParamField>
...
<ParamField path="path" type="string" required={true}>
  Relative filepath to the desired landing page Markdown file. The path is relative to the configuration file where it's set.
</ParamField>
