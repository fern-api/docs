...
Global themes work in self-hosted deployments when the theme is vendored into the Docker image. See [Global themes in self-hosted](/learn/docs/self-hosted/set-up#global-themes-in-self-hosted) for the Dockerfile pattern and fallback behavior.
