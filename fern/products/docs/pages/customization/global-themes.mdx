...
Products carried by a theme appear as links on every site except the one that owns them, so they can't use [versions](/learn/docs/configuration/products#add-versioning-to-your-products).
