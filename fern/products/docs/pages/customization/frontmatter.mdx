...
<ParamField path="last-updated" type="string" required={false}>
  Displays a "Last updated at" message in the page header. Use this to show readers when the content was last modified. The value is displayed as-is, so you can use any date format you prefer.
</ParamField>
