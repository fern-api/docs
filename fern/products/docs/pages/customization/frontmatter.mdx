...
description: "C# SDK reference"
subtitle: "Terms & conditions"
```

**Characters that need escaping:** `{`, `}`, `<`, `>`

These have special meaning in MDX and must be escaped with a backslash, even inside quotes:

```yaml
title: "Using \<Callout\> components"
subtitle: "Object syntax \{key: value\}"
```
