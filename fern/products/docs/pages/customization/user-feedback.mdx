...
<Frame caption="On-page feedback">
  <video
    src="/products/docs/pages/customization/assets/user-feedback.mp4"
    autoPlay
    loop
    playsInline
    muted
...
<Frame caption="Dashboard mode">
  <video
    src="/products/docs/pages/customization/assets/fern-edit-this-page.mp4"
    autoPlay
    loop
    playsInline
    muted
