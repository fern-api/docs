...
For example, [You.com](https://you.com/docs/welcome) uses a custom React component on their docs homepage to let visitors explore different APIs with an interactive code playground:

<Frame caption="You.com's custom API explorer component with tabbed navigation and language switching">
<img src="./youcom-api-explorer.png" />
</Frame>
