...
<Frame caption="Merge uses custom React components on [their docs homepage](https://docs.merge.dev/home) to showcase each product with branded illustrations, descriptions, and CTAs.">
  <video
