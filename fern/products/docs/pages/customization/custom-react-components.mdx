...
/>
  ...
  Components can also import third-party npm packages installed in your docs project's `node_modules` <Badge intent="warning" minimal>Beta</Badge>. The Fern CLI bundles these dependencies into your components at build time.
