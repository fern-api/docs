...
For example, [Merge](https://docs.merge.dev/home) uses custom React components on their docs homepage to showcase each product with branded illustrations, descriptions, and CTAs:

<Frame caption="Merge's custom product showcase cards on their docs homepage">
<img src="./merge-product-cards.png" />
</Frame>
