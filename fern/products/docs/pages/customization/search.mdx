...
## Using Algolia directly

If you need to integrate Fern documentation search into your own application, you can use the Algolia search API directly. Contact the Fern team to request Algolia credentials for your implementation.

The Algolia API allows you to:
- Search across all documentation content
- Apply filters for specific content types
- Access the same search index used by the Fern documentation site
