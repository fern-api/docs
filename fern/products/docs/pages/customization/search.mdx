...
If you're using [Ask AI](/learn/docs/ai-features/ask-fern/overview) (AI search), the search box also functions as your site's chat window.
...
<Note>
  ...
  AI](/learn/docs/ai-features/ask-fern/overview) queries the same Algolia index
