...
| --- | --- | --- |
| 1 | Keywords | Keywords set in the page's [frontmatter](/learn/docs/configuration/page-level-settings#seo-properties) |
| 2 | Page title | The title set in frontmatter or `docs.yml` |
...
Keywords are the highest-weighted attribute in Fern's search ranking. Adding targeted keywords to a page helps surface it for specific search queries without changing the page content.
