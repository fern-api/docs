...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/api-references/http-snippets">Read the docs</Button>
...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/writing-content/components/runnable-endpoint">Read the docs</Button>
