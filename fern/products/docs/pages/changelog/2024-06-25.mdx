...
<ChangelogTags>seo, integrations</ChangelogTags>
...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/seo/setting-seo-metadata#structured-data-json-ld">Read the docs</Button>
...
<Button intent="none" outlined rightIcon="arrow-right" href="/learn/docs/configuration/page-level-settings">Read the docs</Button>
