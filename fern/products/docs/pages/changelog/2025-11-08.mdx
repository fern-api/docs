...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/writing-content/reusable-snippets">Read the docs</Button>
...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/writing-content/components/copy">Read the docs</Button>
