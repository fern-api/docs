...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/configuration/page-level-settings#last-updated">Read the docs</Button>
...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/api-references/write-markdown-in-api-reference#adding-markdown-content-to-endpoints">Read the docs</Button>
