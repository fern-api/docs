...
Ask AI now uses [Claude 4.6 Sonnet](https://www.anthropic.com/news/claude-sonnet-4-6) and [Claude 4.5 Haiku](https://www.anthropic.com/news/claude-haiku-4-5).
...
<Button
  ...
  outlined
  rightIcon="arrow-right"
  href="/learn/docs/writing-content/markdown-basics#api-link-syntax"
>
  Read the docs
</Button>
