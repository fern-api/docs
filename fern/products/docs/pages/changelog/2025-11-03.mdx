...
- **Custom image files**: Use relative paths to custom image files (e.g., `./assets/icons/plant-icon.svg`). Paths are relative to the file where the icon is referenced, such as `docs.yml`, `product.yml`, `navigation.yml`, or `version.yml`.
