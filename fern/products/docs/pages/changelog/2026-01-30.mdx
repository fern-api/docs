...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/writing-content/components/tables#searchable-tables">Read the docs</Button>
...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/configuration/site-level-settings#layout-configuration">Read the docs</Button>
...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/writing-content/components/code-blocks">Read the docs</Button>
