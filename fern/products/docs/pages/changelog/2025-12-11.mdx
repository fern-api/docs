...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/configuration/site-level-settings#logo-configuration">Read the docs</Button>
...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/configuration/site-level-settings#theme-configuration">Read the docs</Button>
