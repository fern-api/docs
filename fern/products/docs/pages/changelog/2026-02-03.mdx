...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/writing-content/components/request-snippet">Read the docs</Button>
...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/configuration/page-level-settings#availability">Read the docs</Button>
...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/configuration/navigation#add-a-folder">Read the docs</Button>
