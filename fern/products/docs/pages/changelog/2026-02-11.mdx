...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/self-hosted/authentication#api-key-injection">Read the docs</Button>
...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/authentication/setup/jwt#build-the-fern-claim">Read the docs</Button>
