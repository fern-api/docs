---
tags: ["ai", "ask-ai", "configuration", "docs.yml"]
---
...
Embed Ask AI's AI-powered search on any React site using the [`@fern-api/search-widget`](https://www.npmjs.com/package/@fern-api/search-widget) package. The widget renders a button that opens a search modal connected to your documentation content. It requires React 19; all other dependencies are bundled.
