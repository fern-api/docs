...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/ai-features/ask-fern/overview#deep-linking">Read the docs</Button>
...
<Button intent="primary" outlined rightIcon="arrow-right" href="/learn/docs/configuration/site-level-settings#settingsfolder-title-source">Read the docs</Button>
