...
description: "Configure URL redirects in Fern Docs to preserve SEO equity when pages move. Define exact path redirects or regex patterns, and use fern check to detect missing redirects."
---
