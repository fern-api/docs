...
A default `robots.txt` is also served at the root of your site that allows all crawlers and points to your `sitemap.xml`.
...
To opt in or out of specific AI crawlers, gate sensitive sections, or signal training and search preferences with the [Cloudflare Content Signals Policy](https://blog.cloudflare.com/content-signals-policy/), [serve a custom `robots.txt`](/learn/docs/seo/robots-txt) at the root of your site instead of the default.
