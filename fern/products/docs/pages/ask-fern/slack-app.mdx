...
Fern stores all questions and answers from Slack interactions for [analytics purposes](/learn/docs/ask-fern/features#analytics).
...
Use the [API Explorer](/learn/docs/ask-fern/api-reference/slack-ask-fern/get-slack-install-link) to get a unique Slack installation link for your organization. Provide:
- Your Fern token
