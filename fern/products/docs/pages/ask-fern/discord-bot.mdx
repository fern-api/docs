...
<Note>
  To install Ask Fern in your Discord server, you must have **Manage Server** permissions.
</Note>

<Steps>
<Step title="Get your unique install link">

Use the [API Explorer](/learn/docs/ai-features/ask-fern/api-reference/discord-ask-fern/create-discord-integration) to get a unique Discord installation link for your organization. Provide:
- Your Fern token
...
2. Select the Ask Fern application
3. In the **Bot** section, click **Edit** next to the bot username
