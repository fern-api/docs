...
`trigger="prompt"` renders a single-line input pinned to the bottom center of the viewport instead of a button. Sending a question opens the chat directly above the input with that question already in flight.
