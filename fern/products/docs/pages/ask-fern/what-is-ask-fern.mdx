...
Enable Ask Fern by adding the `ai-search` configuration to your [`docs.yml` file](/learn/docs/ai-features/ask-fern/setup) and activating it in the [Fern Dashboard](https://dashboard.buildwithfern.com/):
