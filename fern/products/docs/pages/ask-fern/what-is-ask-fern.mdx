...
The **Conversations** panel reports a **resolution rate** over the last week, month, or year:

- **Resolved**: the user was provided a cited response to their question.
- **Unresolved**: the assistant was unable to find any relevant information.
- **Resolution rate**: resolved conversations as a percentage of total conversations in the selected time window.
</Accordion>
