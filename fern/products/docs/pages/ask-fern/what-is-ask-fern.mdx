...
<Steps>
  ...
  <Step title="Query processing">
    When users ask questions, Ask Fern vectorizes their query and searches the database to find the most relevant documentation and code chunks. If you have [role-based access control](/learn/docs/authentication/rbac/overview) configured, Ask Fern filters results based on the user's permissions.
  </Step>
