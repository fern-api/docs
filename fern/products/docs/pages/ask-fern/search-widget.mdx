...
- **A live, cloud-hosted Fern Docs site with [Ask AI enabled](/learn/docs/ai-features/ask-fern/overview)** — the widget connects to your published docs site at runtime. Self-hosted and local preview environments aren't supported.
...
<ParamField path="domain" type="string" required={true}>
  The URL of your published Fern Docs site (for example,
  `https://docs.example.com`). Include the full path if your docs aren't at the
  root (for example, `https://buildwithfern.com/learn`).
</ParamField>
