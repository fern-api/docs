...
- **A live, cloud-hosted Fern Docs site with [Ask AI enabled](/learn/docs/ai-features/ask-ai/overview)** — the widget connects to your published docs site at runtime. Self-hosted and local preview environments aren't supported.
