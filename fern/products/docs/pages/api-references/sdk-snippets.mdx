...
You can integrate Fern's documentation search functionality into your own application using our Algolia credentials. Contact us to receive API credentials that will allow you to directly query our documentation search index.

The search integration enables you to:
- Search across all Fern documentation content
- Get relevant results formatted for easy display
- Integrate search functionality seamlessly into your application

<Callout intent='info'>
Access to Fern's documentation search is available upon request. Contact the Fern team to receive your Algolia credentials.
</Callout>
