...
<Note>
  To display different package names for SDK users versus documentation users, [use overrides files](/api-definitions/overrides#separate-overrides-for-sdks-and-docs).
</Note>
