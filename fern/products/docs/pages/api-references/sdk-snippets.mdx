...
SDK snippets are static code examples that are generated from your API definition examples. Alternatively, dynamic snippets allow users to modify parameters and see code examples update in real time. To enable dynamic snippets, complete the setup instructions on this page and then [contact us](https://buildwithfern.com/contact).
