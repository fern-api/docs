...
<llms-ignore>
<a className="fern-card interactive not-prose rounded-3 relative block border p-6 text-base fe-action-button" href="https://graphql.docs.buildwithfern.com/api-reference/plant-store-graph-ql-api/plant-store/queries/getPlant">
  ## See live example
