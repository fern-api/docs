...
<Info>
  See the [complete GraphQL example project](https://github.com/fern-api/docs-examples/tree/main/graphql) for a working configuration with a plant store schema.
</Info>
