...
See the [live example site](https://graphql.docs.buildwithfern.com/api-reference/plant-store-graph-ql-api/plant-store/queries/getPlant) or browse the [source on GitHub](https://github.com/fern-api/docs-examples/tree/main/graphql).
