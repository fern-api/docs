...
<ParamField path="api.specs[].origin">
  URL of your GraphQL API endpoint. Fern performs [introspection](https://graphql.org/learn/introspection/) against this endpoint to fetch the schema. When set, running `fern api update` updates the local schema from this endpoint.
</ParamField>
