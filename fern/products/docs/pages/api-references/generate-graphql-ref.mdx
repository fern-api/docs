...
<Info>
  See the [live example](https://graphql.docs.buildwithfern.com) or browse the [source on GitHub](https://github.com/fern-api/docs-examples/tree/main/graphql) for a working configuration with a plant store schema.
</Info>
