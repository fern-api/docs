...
<Frame caption={<>See the <a href="https://graphql.docs.buildwithfern.com">live example site</a> or browse the <a href="https://github.com/fern-api/docs-examples/tree/main/graphql">source on GitHub</a>.</>}>
  <iframe
