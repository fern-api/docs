...
<Frame caption="See the [live example site](https://graphql.docs.buildwithfern.com) or browse the [source on GitHub](https://github.com/fern-api/docs-examples/tree/main/graphql).">
  <iframe
