...
To skip `generators.yml`, [reference the schema directly](/learn/docs/api-references/generate-api-ref#reference-a-spec-directly-from-docsyml) with `specs` and `type: graphql`.
