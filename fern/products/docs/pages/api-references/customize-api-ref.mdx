...
<ParamField path="api" type="string" required={true}>
  ...
  <Badge color="green">OpenAPI</Badge> <Badge color="blue">Fern Definition</Badge> <Badge color="orange">GraphQL</Badge> <Badge color="purple">OpenRPC</Badge> <Badge color="red">Webhook</Badge> <Badge color="yellow">WebSocket</Badge>
</ParamField>
...
<ParamField path="audiences" type="list<string>">
  ...
  <Badge color="green">OpenAPI</Badge> <Badge color="blue">Fern Definition</Badge>
</ParamField>
