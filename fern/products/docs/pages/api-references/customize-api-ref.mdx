...
description: Customize your API reference layout with Fern. Order sections and endpoints, flatten navigation, hide endpoints, and add custom content.
---
...
- `operation: OPERATION_TYPE operationName` (for [GraphQL](/learn/docs/api-references/generate-graphql-ref#customize-the-layout))
</Note>
