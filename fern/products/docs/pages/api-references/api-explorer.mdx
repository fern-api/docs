...
You can control whether the API Explorer is available globally or for specific endpoints using the [`x-fern-explorer`](/learn/api-definitions/openapi/extensions/explorer) OpenAPI extension.
