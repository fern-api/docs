...
description: "Reduce time-to-200 with the Fern API Explorer. Let users send authenticated requests to your API directly from the API Reference, with autopopulated examples and environment switching."
---
