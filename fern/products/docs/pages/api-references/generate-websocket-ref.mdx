...
To skip `generators.yml`, [reference the spec directly](/learn/docs/api-references/generate-api-ref#reference-a-spec-directly-from-docsyml) with `specs` and `type: asyncapi`.
