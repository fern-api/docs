...
<Info>
  Use the [Fern Dashboard](https://dashboard.buildwithfern.com) to manage CLI access, your GitHub repository connection, and monitor analytics and broken links.
</Info>
