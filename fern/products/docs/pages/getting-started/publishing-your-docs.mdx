...
You can unpublish a docs site directly from the [Fern Dashboard](https://dashboard.buildwithfern.com). Unpublishing makes the domain no longer publicly accessible, but doesn't delete the site — you can republish it at any time.
...
<Note>
Unpublishing is useful for creating draft sites or temporarily hiding a site from public view. Since the site isn't deleted, you can republish it whenever you're ready.
</Note>
