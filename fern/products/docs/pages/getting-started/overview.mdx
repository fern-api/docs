...
- [Quickstart](/learn/docs/getting-started/quickstart): Set up a documentation site in under 5 minutes.
- [Configure with ease](/learn/docs/configuration/site-level-settings): Use one simple file to generate documentation that fits your brand.

## Features

Build your own components, enable Ask Fern, generate API references, and update your docs.

- [Flexible component library](/learn/docs/writing-content/components/overview): Use pre-built or custom React components for a polished look.
- [Fern Editor](/learn/docs/writing-content/fern-editor): Modify your documentation without touching code and publish to your GitHub.
- [Bring your own API spec](/learn/docs/api-references/generate-api-ref): Use OpenAPI, AsyncAPI, gRPC, OpenRPC, and the Fern spec.
- [AI features](/learn/docs/ai-features/overview): AI-native features including Ask Fern and AI-generated examples.
- [Self-host your docs](/learn/docs/self-hosted/overview): Deploy on your own infrastructure to meet security or compliance requirements.
</llms-only>
