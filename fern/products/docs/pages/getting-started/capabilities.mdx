...
Create a `changelog/` directory inside your `fern/pages/` folder and add `.mdx` files named by date (e.g., `2024-01-15.mdx`). Register the changelog in `docs.yml` under your navigation using `changelog: ./pages/changelog`. Each file becomes a dated changelog entry.
