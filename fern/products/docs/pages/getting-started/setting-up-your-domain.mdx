...
Reach out via your dedicated Slack channel or [email](mailto:support@buildwithfern.com). We'll provide you with:
...
3. Add a new CNAME record with the following details:
   ...
   - **Value**: The unique CNAME value provided by Fern
4. Add the TXT record provided by Fern to verify your domain.
...
Contact Fern Support via your dedicated Slack channel or [email](mailto:support@buildwithfern.com). We'll provide you with:
- A unique CNAME value for your site
- A TXT record to verify your domain
