...
<Files>
  <Folder name="fern" defaultOpen>
    <Folder name="pages" comment="Contains the Markdown (MDX) files" />
    <Folder name="assets" comment="Contains images or videos" />
    <File name="docs.yml" highlighted comment="Defines navigation, theme, and hosting" />
  ...
  <Accordion title="OpenAPI">
    ...
    <Files>
      <Folder name="openapi" defaultOpen>
        <File name="openapi.yaml" highlighted comment="OR openapi.json" />
  ...
  <Accordion title="Fern Definition">
    ...
    <Files>
      <Folder name="definition" defaultOpen>
        ...
        <File name="overrides.yaml" comment="Optional" />
        <File name="api.yaml" highlighted />
      </Folder>
    </Files>
    ...
    <Files>
      <Folder name="apis" defaultOpen>
        ...
        <Folder name="user-api">
          <Folder name="definition" comment="Auto-detected for Fern Definition">
            <File name="api.yml" />
            <File name="overrides.yaml" comment="Optional" />
          </Folder>
        </Folder>
