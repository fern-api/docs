...
<AccordionGroup>
  <Accordion title="OpenAPI">
    ...
    In addition to your specification file, you can optionally [add an overrides file](/api-definitions/overrides) for additional customizations. 
  ...
  <Accordion title="Fern Definition">
    ...
    You can optionally [add an overrides file](/api-definitions/overrides) for additional customizations. 
