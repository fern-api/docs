...
When you start with Fern, the setup process creates and configures:

- **Organization**: An organization using your org ID, with you as a member.
- **GitHub repository**: A repository to store your documentation source files, including your `docs.yml` configuration, Markdown pages, and any API specifications.
...
## Content and deployment workflows

Once your documentation is set up, there are two major workflows: **editing** and **deploying** your documentation.
...
<AccordionGroup>
<Accordion title="Editing and deployment workflow diagrams">
