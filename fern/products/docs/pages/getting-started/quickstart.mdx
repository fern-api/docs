...
2. **`fern generate --docs --preview`**: Builds the site and uploads it to a temporary preview link you can share with your team. The [starter template](https://github.com/fern-api/docs-starter) includes a GitHub Actions workflow that generates preview links automatically on pull requests.
