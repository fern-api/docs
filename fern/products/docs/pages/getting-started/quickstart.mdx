...
<Tip>
  Follow this guide to get started with Fern using the CLI, or use the [self-service setup](https://dashboard.buildwithfern.com/get-started) for a guided UI flow.
