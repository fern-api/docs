...
<Prompt title="Build a docs site with Fern">
Help me build and publish a docs site with Fern. Follow the [Docs quickstart](https://buildwithfern.com/learn/docs/getting-started/quickstart.md) step by step.
</Prompt>
