...
<Steps toc={true}>
  ...
  <AccordionGroup toc={true}>
    <Accordion title='Add content' >
      ...
      <!-- Disable image zoom with noZoom attribute -->
      <img src="path/to/image.png" alt="My Image" noZoom />
      ```

      <Note title="Supported Syntax">
      Fern supports [GitHub flavored Markdown (GFM)](https://github.github.com/gfm/) within MDX files, no plugin required. To disable image zoom functionality, add the `noZoom` attribute to your image tags.
      </Note>
