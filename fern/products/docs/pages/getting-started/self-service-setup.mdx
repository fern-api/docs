...
- **GitHub Action**: A workflow that runs [`fern generate --docs`](/learn/cli-api-reference/cli-reference/docs-commands#fern-generate---docs) whenever you push changes to your main branch, automatically rebuilding and publishing your documentation.
...
3. Run the following command from within your Fern project directory to generate a new API key:
   ```bash
   fern token
   ```
