...
description: "Restrict access to your documentation site with one or more shared passwords. Map passwords to roles and combine with RBAC for pre-release docs and other private content."
---
