...
description: "Secure your documentation behind your corporate identity provider with SAML or OIDC single sign-on so employees and partners can log in with their existing credentials."
---
