...
description: "Set up Fern-managed OAuth so visitors authenticate through your existing identity provider. Fern handles the auth flow and fern_token cookie, enabling RBAC and API key injection."
---
