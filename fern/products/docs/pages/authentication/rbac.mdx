...
Restricted pages display a lock icon next to the page title. Hovering over the icon shows which roles have access:

- **Pages without `viewers`**: "Only visible to authenticated users."
- **Pages with `viewers`**: lists the role names that can view the page.
