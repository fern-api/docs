...
Unauthenticated users can only access sections marked as `viewers: everyone`. Other roles can access work trial content, engineering documentation, and contractor information.
