...
1. When a user clicks the **Login** button, they're redirected to your authentication page.
...
Reach out to Fern to get your secret key and send them the URL of your authentication page. This is where users are redirected after clicking the **Login** button in the API Explorer.
</Step>
