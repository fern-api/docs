...
- **[Password protection](/learn/docs/authentication/setup/password-protection)** — You need quick gating with a shared password. No per-user accounts, no setup beyond `docs.yml`. Supports [role-based access control](/learn/docs/authentication/features/rbac).
