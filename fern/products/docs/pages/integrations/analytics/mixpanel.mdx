...
<Steps>
	...
	<Step title="Create a scripts folder">
	...
	<Step title="Test your integration">
		...
		1. Run `fern docs dev` to build and start your Fern docs locally.
		2. Open your browser's developer tools and check the Console and Network tabs to confirm the Mixpanel script is loading correctly.
		3. Navigate through your docs site and verify that events are being tracked.
		4. Go to your Mixpanel project dashboard to verify that events are being received correctly.
