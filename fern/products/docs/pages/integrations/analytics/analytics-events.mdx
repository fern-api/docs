...
<Note>
  [FullStory](/learn/docs/integrations/analytics/fullstory) and
  [Intercom](/learn/docs/integrations/support/intercom) provide session
  recording and live chat respectively. They don't receive the named events
  listed below.
</Note>
...
These events are emitted by the [on-page feedback](/learn/docs/user-feedback) widget and the Ask AI feedback component.
...
These events track [search](/learn/docs/customization/search) and [Ask AI](/learn/docs/ai-features/ask-fern/overview) usage.

| Event            | Description                         | Forwarded to              |
| ---------------- | ----------------------------------- | ------------------------- |
| `ask_ai_suggest` | An Ask AI suggestion was generated. | None (Fern internal only) |
