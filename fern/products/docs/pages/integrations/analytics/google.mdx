...
GTM adds `'unsafe-eval'` to your site's [Content Security Policy](/learn/docs/security/content-security-policy#google-tag-manager), because GTM evaluates Custom JavaScript variables with `eval`.
