...
The Icon size can be customized directly, it is calculated as a multiple of `8` as the base size.

For example, for a `24px` icon, set `iconSize` to `6`
...
<div className="highlight-frame">
  <Card 
      ...
      iconSize={6}
  >
      You can set the icon size as a calculation of `N * 4`.
  </Card>
</div>
