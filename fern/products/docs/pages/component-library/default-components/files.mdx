...
Use the `highlighted` property to visually emphasize specific files or folders with an accent background color, and the `comment` property to add explanatory text that appears next to the item. This is useful for drawing attention to important files or providing additional context, similar to how code blocks support line highlighting and inline comments.
...
<ParamField path="highlighted" type="boolean" default={false}>
  Whether the folder should be visually highlighted with an accent background color. Use this to draw attention to important directories.
</ParamField>
...
<ParamField path="highlighted" type="boolean" default={false}>
  Whether the file should be visually highlighted with an accent background color. Use this to draw attention to important files.
</ParamField>
