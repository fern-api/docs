...
Pass plain text as the child to create a simple text link as the download trigger.

<div className="highlight-frame">
  <div className="highlight-frame-content">
  <Download src="./all-about-ferns.pdf">click here to download</Download>
  </div>
</div>

```jsx Markdown
<Download src="./file.csv">click here to download</Download>
```
