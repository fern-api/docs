...
<div className="highlight-frame">
  ...
  <Download
    sources={[
      "https://raw.githubusercontent.com/fern-api/docs/main/fern/products/docs/pages/component-library/default-components/all-about-ferns.pdf",
      "https://raw.githubusercontent.com/fern-api/docs/main/fern/products/docs/pages/component-library/default-components/fern-care-guide.txt",
      "https://raw.githubusercontent.com/fern-api/docs/main/fern/products/docs/pages/component-library/default-components/watering-schedule.txt"
    ]}
    filename="plant-care-bundle.zip"
  >
    <Button intent="primary">Download plant care guides</Button>
  </Download>
  </div>
</div>
...
<Download
  sources={[
    "https://example.com/plants/fern-care-guide.pdf",
    "https://example.com/plants/watering-schedule.pdf",
    "https://example.com/plants/sunlight-requirements.pdf"
  ]}
  filename="plant-care-bundle.zip"
>
  <Button intent="primary">Download plant care guides</Button>
