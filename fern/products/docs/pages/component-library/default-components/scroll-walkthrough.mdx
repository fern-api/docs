...
The walkthrough splits the content area between prose and the code panel, so a page-level table of contents leaves both columns cramped. Fern recommends setting [`hide-toc`](/learn/docs/configuration/page-level-settings#hide-table-of-contents) on pages built around a walkthrough:
