...
<Tip>
Set the [`reference` layout](/learn/docs/configuration/page-level-settings#layout) on pages built around a walkthrough. It gives the prose and the code panel the full content width.
</Tip>
