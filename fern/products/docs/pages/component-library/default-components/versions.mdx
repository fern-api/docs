...
<div className="highlight-frame">
  ...
  <Versions>
    <Version version="v2.0" title="Version 2.0" default>
      This content is for version 2.0 (the default).
    </Version>
    <Version version="v1.0" title="Version 1.0">
      This content is for version 1.0.
    </Version>
  </Versions>
  </div>
</div>
...
<div className="highlight-frame">
  ...
  <Versions paramName="sdk-version">
    <Version version="latest" title="Latest" default>
      Content for the latest SDK version.
    </Version>
    <Version version="legacy" title="Legacy">
      Content for the legacy SDK version.
    </Version>
  </Versions>
  </div>
</div>
