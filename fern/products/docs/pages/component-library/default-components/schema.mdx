...
Similar to [`<EndpointSchemaSnippet>`](/learn/docs/writing-content/components/endpoint-schema-snippet), but accepts any type name rather than being limited to endpoint-specific schemas.
