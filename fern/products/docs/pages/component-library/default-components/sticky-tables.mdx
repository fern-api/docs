...
Sticky tables display tabular data with a fixed header that remains visible while scrolling through table rows. This is useful for longer tables where users need to reference column headers while viewing data further down the table.
