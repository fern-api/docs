---
title: Indent
description: Learn how to use the Indent component in Fern to add left indentation with vertical guide lines for nested parameters and hierarchical content.
---
