...
Container for product selection dropdown. Custom styling can be applied for specific layouts.
...
**Usage notes:**
- Applied to the FernDropdown component wrapper in the product selector
- See the [docs repo styles.css](https://github.com/fern-api/docs/blob/main/fern/styles.css) for advanced customization examples
- Source: [ProductDropdownClient.tsx](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/components/src/header/ProductDropdownClient.tsx)

</Accordion>

<Accordion title=".fern-product-selector-radio-group">

Radio button group for selecting products. Can be customized with grid layouts for multi-column display.

**Usage notes:**
- Applied to the radio group within the product selector dropdown
- Can be customized with CSS grid for multi-column layouts
- See the [docs repo styles.css](https://github.com/fern-api/docs/blob/main/fern/styles.css) for grid layout examples
- Source: [ProductDropdownClient.tsx](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/components/src/header/ProductDropdownClient.tsx)
...
Anchor link for [deep linking to sections](/learn/docs/component-library/default-components/anchor). Positioned absolutely within step components and can be customized for visibility and positioning.
...
**Usage notes:**
- Source: [FernAnchor.scss](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/bundle/src/components/FernAnchor.scss)

</Accordion>

<Accordion title=".fern-table-root">

Root container for table component. Used for custom table implementations and provides base styling for table layouts.
...
**Usage notes:**
- Source: [html-table/index.scss](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/bundle/src/mdx/components/html-table/index.scss)

</Accordion>

<Accordion title=".fern-table">

Styled table element. Provides consistent table styling and works with sticky table headers.
...
**Usage notes:**
- Supports `.sticky` modifier for sticky table headers
- Source: [html-table/index.scss](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/bundle/src/mdx/components/html-table/index.scss)
...
Icon element in documentation content. Used for inline icons in text and automatically sized and colored.
...
**Usage notes:**
- Automatically adapts to light/dark mode using CSS variables
- Source: [icon/index.scss](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/bundle/src/mdx/components/icon/index.scss)

</Accordion>

<Accordion title=".fern-mdx-tooltip-trigger">

Element that triggers tooltip on hover. Used for inline tooltips in documentation.
...
**Usage notes:**
- Provides CSS custom properties for customizing underline appearance
- Source: [tooltip/tooltip.scss](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/bundle/src/mdx/components/tooltip/tooltip.scss)

</Accordion>

<Accordion title=".fern-mdx-tooltip-content">

Content displayed in tooltip. Positioned absolutely relative to trigger and supports multiple positioning options.
...
**Usage notes:**
- Provides CSS custom property for customizing horizontal padding
- Source: [tooltip/tooltip.scss](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/bundle/src/mdx/components/tooltip/tooltip.scss)
...
Icon representing a file type. Used in selection items and file browsers, and scales on hover within selection items.
...
**Usage notes:**
- Automatically scales on hover when used within `.fern-selection-item`
- Source: [FernSelectionItem.scss](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/components/src/FernSelectionItem.scss)

</Accordion>

<Accordion title=".fern-collapsible-child">

Child element within collapsible content. Used for nested collapsible sections.
...
**Usage notes:**
- Animated when parent collapsible opens/closes
- Source: [utilities.scss](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/components/src/utilities.scss)

</Accordion>

<Accordion title=".fern-runnable-endpoint">

[Interactive API endpoint that can be executed](/learn/docs/component-library/default-components/runnable-endpoint). Used in API playground features and allows users to test API calls directly from documentation.
...
**Usage notes:**
- Provides special styling for disabled inputs within the runnable endpoint component
- Source: [runnable-endpoint/index.scss](https://github.com/fern-api/fern-platform/blob/main/packages/fern-docs/bundle/src/mdx/components/runnable-endpoint/index.scss)
