...
4. **Use specificity carefully**: Fern uses Tailwind's `@layer` directive. Your custom CSS should have appropriate specificity to override defaults without using `!important` excessively.
