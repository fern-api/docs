...
description: Reference guide for all .fern-* CSS selectors available in Fern docs. Customize layouts, navigation, buttons, forms, accordions, badges, API components, and theme modes.
max-toc-depth: 3
---
