...
For custom header and footer components, or other reusable React components in your documentation, see [Custom React components](/learn/docs/writing-content/custom-react-components).                                                                                