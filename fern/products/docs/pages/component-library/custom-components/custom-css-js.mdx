...
For the full list of available CSS variables, color scales, and theme customization techniques, see the [CSS selectors reference](/learn/docs/customization/css-theming-and-changelog-selectors#light-and-dark-mode-customization).
