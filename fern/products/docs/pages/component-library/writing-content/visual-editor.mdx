...
<AccordionGroup>
  ...
  <Accordion title="Can I use Fern Editor with self-hosted documentation?">
    Yes. Self-hosted documentation users can use Fern Editor to edit their docs. Changes are committed to your GitHub repository and can be deployed to your self-hosted environment.
