...
For [Cards](/learn/docs/writing-content/components/cards), the Card properties panel includes a **Source** field for the card image and an **Image Position** selector (`top`, `left`, `right`, or `bottom`). Repo-relative image paths resolve in the editor, and the preview matches the published Card component.
