...
<AccordionGroup>
  ...
  <Accordion title="Does Fern Editor support all components?">
    Fern Editor currently supports most built-in components, with additional components being added regularly. See the table above for the current support status of each component.
