...
Since dollar signs trigger LaTeX rendering, text containing dollar amounts may render as math equations. To display literal dollar signs in your documentation (like prices, budgets, costs, or financial data), escape them with a backslash (`\`):
