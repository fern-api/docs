...
Text between two dollar signs is rendered as a LaTeX equation. For example, `$10 this is sample text $20` renders as $10 this is sample text $20. To display dollar signs as literal text, escape them with a backslash: `\$10 this is sample text \$20` renders as \$10 this is sample text \$20.
