...
### Embed external sites

You can embed any external web page in your documentation using an `<iframe>`. This is useful for embedding live demos, dashboards, or interactive tools.
...
To embed a Fern docs site inside another application, append `?embedded=true` to the URL to hide the header and footer. See [Embedded mode](/learn/docs/customization/embedded-mode).
