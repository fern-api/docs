...
| Feature | Fern Docs | Stainless Docs |
|---------|-----------|----------------|
| **API Explorer** | ✅ [Full playground](/learn/docs/api-references/api-explorer) with [auto-populated credentials](/learn/docs/authentication/api-key-injection), WebSocket, and audio streaming support | ❌ None |
...
| **Authenticated pages** | ✅ [Login-protected documentation](/learn/docs/authentication/overview) with [auto-populated credentials](/learn/docs/authentication/api-key-injection) | ⚠️ API keys for Stainless service only |
<br/>
</Accordion>
