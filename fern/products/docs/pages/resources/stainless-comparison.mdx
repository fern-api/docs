...
Stainless offers RAG-based search. Fern provides additional AI features including [guidance documents](/learn/docs/ai-features/ask-ai/guidance), [custom knowledge sources](/learn/docs/ai-features/ask-ai/content-sources), and analytics for operational control.

| Feature                 | Fern Docs                                                                                                                                                         | Stainless Docs                         |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| **AI chatbot**          | ✅ [Ask AI](/learn/docs/ai-features/ask-ai/overview) with Claude, [guidance documents](/learn/docs/ai-features/ask-ai/guidance), and custom knowledge sources | ✅ RAG-based Q&A                       |
| **AI analytics**        | ✅ [Content gap identification](/learn/docs/ai-features/ask-ai/overview) and insights                                                                           | ❌ None                                |
