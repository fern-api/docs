...
| Feature                 | Fern Docs                                                                                                                                                         | Stainless Docs                         |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| **AI chatbot**          | ✅ [Ask AI](/learn/docs/ai-features/ask-fern/overview) with Claude, [guidance documents](/learn/docs/ai-features/ask-fern/guidance), and custom knowledge sources | ✅ RAG-based Q&A                       |
