...
You can also change the visual style of tabs using the [`theme.tabs`](/learn/docs/configuration/site-level-settings#themetabs) setting. `default` uses underlined tabs; `bubble` displays tabs with rounded pill-shaped backgrounds.
...
<Accordion title="All tab properties">
...
<ParamField path="changelog" type="string">
  Path to a [changelog](/learn/docs/content/changelogs) folder relative to the `fern` directory
</ParamField>
...
<Accordion title="All variant properties">
