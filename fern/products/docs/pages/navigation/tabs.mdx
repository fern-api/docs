...
<Info>
  You can also set placement [via `layout.tabs-placement`](/learn/docs/configuration/site-level-settings#layouttabs-placement), but `theme.tabs.placement` takes precedence when both are set.
</Info>
