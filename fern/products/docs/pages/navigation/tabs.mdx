...
Tab variants let you display different content variations within a single tab, and [support RBAC](/learn/docs/authentication/rbac/overview). This is useful for showing different user types, implementation approaches, or experience levels without creating separate tabs.
