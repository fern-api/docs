...
| `description` | HTML `<meta name="description">` tag, search snippets, `llms.txt` | Falls back to `subtitle` |
| `og:description` | Social sharing previews (OpenGraph) | Falls back to `description` |
