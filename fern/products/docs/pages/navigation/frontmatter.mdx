...
<Note>
**Migrating from Mintlify?** In Mintlify, the frontmatter `description` field renders as visible subtitle text and doubles as `og:description`. In Fern, these are separate: use `subtitle` for visible page text and `description` for the HTML meta description.
</Note>
