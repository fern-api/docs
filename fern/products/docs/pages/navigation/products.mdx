...
description: "Add a product switcher to multi-product documentation sites so each product has its own navigation, tabs, versions, and API references, with both internal and external products supported."
---
