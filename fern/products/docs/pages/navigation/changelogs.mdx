...
<Note>
Customize the filter UI using [changelog filter CSS selectors](/learn/docs/customization/css-theming-changelog-selectors#changelog-filter-components). These selectors only apply when tags are configured.
</Note>
