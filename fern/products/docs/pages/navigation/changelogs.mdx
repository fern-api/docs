...
description: "Publish a changelog that auto-populates from a changelog folder. Tag entries by category, expose them via RSS, and keep readers informed as your project evolves."
---
