...
<Note>
This per-changelog override takes priority over both the site-wide `layout.changelogLayout` setting in `docs.yml` and the `changelog-classic-layout` edge-config flag.
</Note>
