  ...
  - display-name: SDKs
    ...
    versions:
      - display-name: v1
        ...
        announcement:
          message: "v1 is in maintenance mode. Please upgrade to v2."
...
In this example:
- Pages in SDKs v1 show "v1 is in maintenance mode. Please upgrade to v2."
...
- Any other products without their own announcement show "Welcome to our documentation!" (config-level)
