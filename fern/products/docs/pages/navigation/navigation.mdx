...
[API Reference sections and endpoints](/learn/docs/api-references/customize-api-ref#adding-availability) render the same sidebar badges based on their availability.
