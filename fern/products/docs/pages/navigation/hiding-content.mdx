...
Hide an entire [section](/learn/docs/configuration/navigation), [tab](/learn/docs/navigation/tabs), [tab variant](/learn/docs/navigation/tabs#tab-variants), or [version](/learn/docs/configuration/versions) from navigation — for example, a legacy API version, an internal tab, or a section of internal tooling docs.
