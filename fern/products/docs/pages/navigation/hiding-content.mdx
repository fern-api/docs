...
Hide an entire section, tab, [tab variant](/learn/docs/navigation/tabs#tab-variants), or version from navigation — for example, a legacy API version, an internal tab, or a section of internal tooling docs.
...
<Tab title="Hidden tab variant">
```yaml title="docs.yml" {5-6}
navigation:
  - tab: help
    variants:
