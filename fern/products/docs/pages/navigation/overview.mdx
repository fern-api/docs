...
### Control link opening behavior

By default, navigation links open in a new tab. You can control this behavior using the `openInNewTab` property:
...
navigation:
  - section: Home
    contents:
      ...
      - link: Our YouTube channel
        href: https://www.youtube.com/
        openInNewTab: true  # Opens in new tab (default)
      - link: Related documentation
        href: https://example.com/docs
        openInNewTab: false  # Opens in current window
```
{/* <!-- vale on --> */}

The `openInNewTab` property accepts a boolean value:
- `true` (default): Opens the link in a new tab
- `false`: Opens the link in the current window
