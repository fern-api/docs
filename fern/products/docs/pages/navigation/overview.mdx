...
<CardGroup cols={2}>
  ...
  <Card title="Navigation overview" icon="fa-duotone fa-sitemap" href="/learn/docs/configuration/navigation-overview">
    How products, versions, tabs, sections, and pages fit together
  </Card>
