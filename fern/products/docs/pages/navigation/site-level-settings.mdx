...
<ParamField path="instances.custom-domain" type="string or list of strings" required={false} toc={true}>
  The custom domain where your documentation is hosted. Declare a domain in [only one docs project](/learn/docs/preview-publish/setting-up-your-domain#one-domain-per-docs-project). Learn more about [setting up a custom domain](/learn/docs/preview-publish/setting-up-your-domain).
</ParamField>
