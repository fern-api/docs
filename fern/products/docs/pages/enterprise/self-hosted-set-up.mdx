...
To deploy to Kubernetes, create a Deployment and Service configuration.
...
Replace `your-registry/fern-docs:latest` with your image name. For health check endpoint details, see [Health check endpoints](/learn/docs/self-hosted/health-check-endpoints).
