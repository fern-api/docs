...
You can also use [Fern Editor](/learn/docs/content/fern-editor) and GitHub in your authoring workflow. Changes made in Fern Editor are committed to your repository and can be deployed to your self-hosted environment.

However, some features requiring external connections aren't supported, including [Ask Fern](/ask-fern/getting-started/what-is-ask-fern) (AI chat), [analytics](/docs/integrations/overview), [live API key population](/docs/authentication/api-key-injection), and [SSO integrations](/docs/authentication/sso).
