...
**PDF export** and **offline AI chat functionality** are not yet available on any plan but are in development for enterprise self-hosted deployments. [Reach out](mailto:support@buildwithfern.com) if you're interested in these features.
</Info>
...
| [Custom domain](/learn/docs/getting-started/setting-up-your-domain) | Yes |
...
| [On-page feedback](/learn/docs/customization/user-feedback) | No |
