...
Self-hosted deployments include core Fern documentation website features like auto-generated API references, interactive documentation, SDK code snippets, search, and customizable branding. Self-hosted users can also use [Fern Editor](/learn/docs/content/fern-editor) to edit documentation visually; changes are committed to your GitHub repository and can be deployed to your self-hosted environment.
