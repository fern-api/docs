...
[PDF export](/learn/dashboard/configuration/pdf-export) is available on managed hosting via the [Fern Dashboard](https://dashboard.buildwithfern.com/). PDF export and **offline AI chat functionality** for self-hosted deployments are in development. [Email us](mailto:support@buildwithfern.com) if you're interested in these features.
</Info>
