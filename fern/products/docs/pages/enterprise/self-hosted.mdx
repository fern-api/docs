...
For Kubernetes and Helm deployments, the self-hosted container includes built-in health check endpoints on port 8081. These endpoints help you monitor container health and handle startup delays gracefully.

Learn more about [health check endpoints](./health-check-endpoints).
