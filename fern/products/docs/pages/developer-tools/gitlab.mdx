...
Create a `.gitlab-ci.yml` file in the root of your repository. This pipeline validates your API definition on merge requests, publishes your docs when changes are merged to `main`, and posts preview links on merge requests.
