---
title: Cursor
description: "Use Cursor with Fern Docs. Add system prompts and project-level .cursorrules to keep AI-generated documentation aligned with your style and conventions."
---
