...
<AccordionGroup>
  ...
  >
    [OpenRPC](https://open-rpc.org/) is a spec for describing JSON-RPC 2.0 APIs. It enables interactive docs, code generation, and tooling—bringing OpenAPI-style benefits to the JSON-RPC ecosystem.
    ...
    ```json maxLines={0}
    {
      ...
      "info": {
        ...
        "version": "1.0.0",
        "description": "A simple JSON-RPC API for managing a crypto wallet."
      },
      "methods": [
        {
          "name": "getBalance",
          "summary": "Get the balance of a wallet address.",
          "params": [
            {
              "name": "address",
              "schema": { "type": "string" },
        ...
        },
        {
          ...
          "summary": "Send crypto to another address.",
          "params": [
            { "name": "from", "schema": { "type": "string" }, "description": "Sender address." },
            { "name": "to", "schema": { "type": "string" }, "description": "Recipient address." },
            { "name": "amount", "schema": { "type": "number" }, "description": "Amount to send." }
          ],
          "result": {
            "name": "txId",
            "schema": { "type": "string" },
