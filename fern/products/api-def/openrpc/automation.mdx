...
subtitle: Automate OpenRPC spec syncing to keep SDKs and documentation current. Set up GitHub Actions, webhooks, and CI/CD integrations with Fern.
description: "Automate OpenRPC spec syncing with Fern's GitHub Action, webhooks, and CI/CD integrations to keep your SDKs and documentation up to date."
---
