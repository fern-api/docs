...
<Note>
For OpenAPI specifications, consider using [OpenAPI overlays](/api-definitions/openapi/overlays) instead. Overlays follow the official [OpenAPI Overlay Specification](https://spec.openapis.org/overlay/v1.0.0.html) and are portable across different tools.
</Note>
