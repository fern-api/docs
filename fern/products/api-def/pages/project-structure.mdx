...
Use this approach when you want to merge multiple APIs into a single SDK package. This works for both distinct APIs and versioned APIs, though it increases package size as all APIs are bundled together. 

For versioned APIs, namespaces let you access different versions like `client.v1` and `client.v2` within the same package. 
