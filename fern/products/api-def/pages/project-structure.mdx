...
<Files>
  <Folder name="fern" defaultOpen>
    ...
    <File name="generators.yml" highlighted comment="Declares APIs and configures SDK generation" />
    <Folder name="spec-folder" comment="definition, openapi, asyncapi, etc.">
  ...
  <Folder name="fern" defaultOpen>
    ...
    <Folder name="apis" defaultOpen>
      <Folder name="user-api" defaultOpen>
        <File name="generators.yml" highlighted comment="Configures user-api SDKs" />
        <File name="openapi.yml" />
      </Folder>
      <Folder name="payments-api">
        <File name="generators.yml" highlighted comment="Configures payments-api SDKs" />
        <File name="openapi.yml" />
      </Folder>
    </Folder>
  </Folder>
