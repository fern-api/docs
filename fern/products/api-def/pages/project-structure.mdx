...
fern/
  ...
  ├─ generators.yml # Declares APIs and configures code generation
...
For Fern Definition, your API configuration is split across two files: `api.yml` for API-wide configuration and separate `.yml` files for your actual endpoint and type definitions. See [What's a Fern Definition?](/api-definitions/ferndef/overview) for more information. 
