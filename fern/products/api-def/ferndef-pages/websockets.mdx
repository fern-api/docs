...
Each WebSocket is defined in its own file, where it is described by the `channel` object. WebSocket definition files are placed in your Fern definition folder alongside your other API definition files.
