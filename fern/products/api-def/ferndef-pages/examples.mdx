...
When you have [global headers defined in your `api.yml`](/api-definitions/ferndef/api-yml/global-headers#global-headers), you need to include them in your endpoint examples to pass validation:
