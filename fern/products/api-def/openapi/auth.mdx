...
To generate SDKs that honor these per-endpoint requirements instead of applying one default scheme everywhere, set [`api.auth: endpoint-security`](/learn/sdks/reference/generators-yml#auth).
