...
To enable the OAuth client-credentials flow in the [API Explorer](/learn/docs/api-references/api-explorer#oauth-client-credentials), add `playground: oauth: true` to the API reference entry in your `docs.yml`.
