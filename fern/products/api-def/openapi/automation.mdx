...
description: "Pull your latest OpenAPI specification into your Fern folder automatically using the sync-openapi GitHub Action so your committed spec stays aligned with your live API."
---
