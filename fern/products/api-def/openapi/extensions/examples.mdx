...
- `request` — the request body properties, placed directly under `request` without any intermediate key.
...
For endpoints that accept a request body, place the properties directly under `request`:
