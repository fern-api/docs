...
| [`x-fern-sdk-namespace`](/learn/sdks/reference/generators-yml#settingsnamespaced-errors) | Declare a shared error response in a namespace when `namespaced-errors` is enabled |
