...
You can include a message using the extended object syntax. The message propagates into generated SDK doc comments (e.g., `@deprecated Use PATCH /plants/{plantId} instead.`).
