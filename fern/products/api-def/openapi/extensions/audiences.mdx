...
description: "Use x-fern-audiences and settings.filter in OpenAPI to filter endpoints, schemas, and properties for different API consumers like public and beta users."
---
