...
description: "Document file upload endpoints in OpenAPI with the multipart/form-data content type, including binary fields and accompanying metadata properties."
---
