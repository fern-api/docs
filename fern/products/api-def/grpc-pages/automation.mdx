...
<Note>
If you're using `local-generation: true` in your `generators.yml`, you must install [buf](https://buf.build/docs/installation) in your GitHub Actions workflow. Use the [bufbuild/buf-setup-action](https://github.com/bufbuild/buf-setup-action) to set up buf.
</Note>
