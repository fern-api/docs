...
<Note>
If you plan to use `local-generation: true` in your `generators.yml`, you must have [buf](https://buf.build/docs/installation) installed on your machine or in your CI/CD environment.
</Note>
