...
Fern provides custom Protocol Buffer options to enhance your API documentation and generated code.

### API navigation name

Just like the OpenAPI `summary` option, you can use `fern.summary` to customize how an API appears in your navigation.

<CodeBlock title="Protobuf">
```protobuf
service CommentsService {
  // This is the Create Comment desc
