...
description: "Configure protocol-specific settings for AsyncAPI servers, channels, operations, and messages with bindings for WebSocket, MQTT, Kafka, and other protocols."
---
