...
description: "Define AsyncAPI message schemas, content types, payloads, and headers in components.messages to structure data exchanged through your event-driven API."
---
