...
description: "Use the x-fern-audiences extension in AsyncAPI to filter operations, channels, and message schemas by audience for your SDKs and API Reference."
---
