...
<Warning>
  **Archived:** Fern Definition documentation is preserved here for existing users but is no longer actively recommended. New projects should use [OpenAPI](/learn/api-definitions/openapi/overview).
</Warning>
