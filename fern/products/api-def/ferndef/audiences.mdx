...
description: "Use audiences in the Fern Definition to segment your API for different consumers — for example public and beta — and filter SDKs and docs accordingly."
---
