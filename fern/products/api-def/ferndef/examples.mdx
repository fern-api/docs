...
description: "Add examples to types and endpoints in the Fern Definition. Examples appear as comments in SDKs, in the API Reference, and in generated Postman collections."
---
