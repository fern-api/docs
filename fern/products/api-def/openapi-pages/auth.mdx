...
<Tip>
If your API uses [namespaces](/learn/sdks/reference/generators-yml#namespace) (multiple API specs), prefix the endpoint with the namespace and `::`. For example, `"iam::POST /oauth/token"`.
</Tip>
