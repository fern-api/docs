...
<Warning>
When overriding a security scheme in `generators.yml`, avoid using the same name as an existing scheme in your OpenAPI spec. Using conflicting names can cause unexpected behavior.
</Warning>
