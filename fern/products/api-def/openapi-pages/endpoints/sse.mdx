...
Streaming endpoints configured with `x-fern-streaming` can be tested directly in the [API Explorer](/learn/docs/api-references/api-explorer#streaming-endpoints), which displays responses in real-time as data arrives.
