...
You can apply these extensions in two ways: by overlaying them in separate override files or by embedding them directly in your OpenRPC specification. See [Overrides](/api-definitions/overrides) for more information. 
