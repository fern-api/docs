...
Make a request to the [Documents API](/learn/ask-fern/api-reference/document/create-document) to index markdown documents with precise control over what gets indexed. This is ideal for content that isn't publicly accessible, like internal documentation, support ticket summaries, or proprietary knowledge base articles. Upload the full markdown content directly along with a optional title and URL.
...
Make a request to the [Websites API](/learn/ask-fern/api-reference/website/index-website) to crawl and index publicly accessible web content like marketing sites and blog posts. Provide a base URL, and Ask Fern will automatically crawl and index the website.
