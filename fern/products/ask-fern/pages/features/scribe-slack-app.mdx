...
To install Scribe in your organization's Slack workspace, you must be a Slack admin. Install the Scribe app in your workspace and add the bot to channels where your team discusses documentation.
