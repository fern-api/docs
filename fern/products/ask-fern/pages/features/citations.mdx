...
When Ask Fern references content from [custom sources added via the Documents or Websites API](/ask-fern/configuration/content-sources), it includes the associated URL as a citation, allowing users to access the original source material.
