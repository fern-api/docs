...
<Steps>
  ...
  <Step title="Add in your custom prompts">
    ...
    You can also leverage Fern's [system prompts](https://github.com/fern-api/fern-platform/blob/ccc57bd57d60631281fc5bb01c2d77a08cf66b1e/packages/fern-docs/search-server/ask-fern/src/utils/system-prompt.ts#L18) as a starting point. 
