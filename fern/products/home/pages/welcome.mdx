  ...
  <div className="main-content">
    ...
    <div className="feature-grid">
      ...
      <div className="docs-card">
        ...
        <img src="./images/docs-preview-light.svg" alt="Docs Preview" className="docs-preview-img dark:hidden" />
        <img src="./images/docs-preview-dark.svg" alt="Docs Preview" className="docs-preview-img hidden dark:block" />
    ...
    <footer className="footer">
      <div className="footer-top">
        ...
        <div className="footer-logo">
          ...
          <img src="./images/builtwithfern-frame-light.svg" alt="Fern" className="footer-logo-img dark:hidden" noZoom />
          <img src="./images/builtwithfern-frame-dark.svg" alt="Fern" className="footer-logo-img hidden dark:block" noZoom />
        </div>
