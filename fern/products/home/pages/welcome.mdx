      ...
      <div className="docs-card">
        ...
        <div className="action-buttons-vertical">
          ...
          <button className="fern-button minimal normal w-fit gap-1">
            ...
            <img src="./images/arrow-right-dark.svg" alt="Arrow right light" no
          </button>
        </div>
      </div>
    ...
    <div className="community-section">
      ...
      <div className="community-grid">
        <div className="community-card">
          <img src="./images/changelog.svg" alt="Changelog Preview" noZoom />
      ...
      <div className="footer-top">
        ...
        <div className="footer-left">
          <div className="footer-logo">
            <img src="./images/fern-footer-wordmark.svg" alt="Fern" className="footer-logo-img" noZoom />
          </div>
