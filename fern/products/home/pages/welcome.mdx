    ...
    <div className="community-section">
      ...
      <div className="community-grid">
        ...
        <div className="community-card">
          ...
          <a className="fern-button outlined normal gap-1 a-btn" href="https://fern-community.slack.com/join/shared_invite/zt-2dpftfmif-MuAegl8AfP_PK8s2tx350Q#/shared-invite/email">
            View
          </a>
        </div>
...
- [Slack](https://fern-community.slack.com/join/shared_invite/zt-2dpftfmif-MuAegl8AfP_PK8s2tx350Q#/shared-invite/email): Connect with the Fern community.
