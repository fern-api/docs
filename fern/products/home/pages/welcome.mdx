      ...
      <div className="sdks-card">
        ...
        <div className="language-icons">
          ...
          <button className="language-icon">
            <img src="./images/ts-logo.svg" alt="TypeScript" className="language-icon-img" />
          </button>
          {/* Python */}
          <button className="language-icon">
            <img src="./images/python-logo.svg" alt="Python" className="language-icon-img" />
          </button>
          {/* Go */}
          <button className="language-icon">
            <img src="./images/go-logo.svg" alt="Go" className="language-icon-img" />
          </button>
          {/* Java */}
          <button className="language-icon">
            <img src="./images/java-logo.svg" alt="Java" className="language-icon-img" />
          </button>
          {/* Ruby */}
          <button className="language-icon">
            <img src="./images/ruby-logo.svg" alt="Ruby" className="language-icon-img" />
          </button>
          {/* C# */}
          <button className="language-icon">
            <img src="./images/csharp-logo.svg" alt="C#" className="language-icon-img" />
          </button>
          {/* PHP */}
          <button className="language-icon">
            <img src="./images/php-logo.svg" alt="PHP" className="language-icon-img" />
          </button>
        </div>
