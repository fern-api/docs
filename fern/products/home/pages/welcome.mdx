...
slug: /
description: Build better developer experiences. Generate SDKs in TypeScript, Python, Go, Java, C#, PHP, Ruby, Swift & Rust. Create interactive API docs with Ask Fern.
hide-toc: true
layout: custom
---
    ...
    <div className="feature-grid">
      ...
      <div className="panel-card ai-search-card">
        <div className="card-header">
          ...
          <p className="card-description">
            AI-powered search to find answers in your documentation instantly.
          </p>
        </div>
