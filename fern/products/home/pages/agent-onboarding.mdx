...
This page is written for a coding agent (Claude Code, Cursor, Codex, or similar) that a user has asked to set up Fern. Readers who aren't agents can paste the prompt from the [Fern homepage](https://buildwithfern.com) into their agent, or follow the [Docs quickstart](/learn/docs/getting-started/quickstart) or [SDKs quickstart](/learn/sdks/overview/quickstart) directly.
