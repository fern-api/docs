...
<ParamField path="ai-search.location" type="list of strings" required={false} toc={true}>
  ...
  - See the [Slack app documentation](/learn/docs/ai-features/ask-fern/slack-app) for Slack setup instructions.
  - See the [Discord bot documentation](/learn/docs/ai-features/ask-fern/discord-bot) for Discord setup instructions.
  </ParamField>
