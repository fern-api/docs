...
<ParamField path="ai-search.location" type="list of strings" required={false} toc={true}>
  ...
  - `slack` enables Ask Fern in Slack ([setup instructions](/learn/docs/ai-features/ask-fern/slack-app))
  - `discord` enables Ask Fern in Discord ([setup instructions](/learn/docs/ai-features/ask-fern/discord-bot))
  </ParamField>
