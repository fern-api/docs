...
<ParamField path="settings.filter" type="object" toc={true}>
  Filter to apply to the OpenAPI specification. Use this to limit which endpoints are included in the generated SDK [based on their paths](/learn/api-definitions/openapi/extensions/audiences#path-based-filtering).
