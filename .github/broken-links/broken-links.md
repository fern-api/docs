...
- [LOCAL_MISSING] https://github.com/fern-api/fern-platform/blob/app/packages/fern-docs/search-server/ask-fern/src/utils/system-prompt.ts (path: packages/fern-docs/search-server/ask-fern/src/utils/system-prompt.ts in fern-api/fern-platform, ref: app)

---
[View workflow run](https://github.com/fern-api/docs/actions/runs/20163243200)
