...
- [UNVERIFIABLE] https://github.com/your-org/docs/blob/main/content/api-reference.mdx (repo clone failed)
- [LOCAL_MISSING] https://github.com/your-org/your-repo/blob/main/asyncapi.yml (path: asyncapi.yml in your-org/your-repo, ref: main)

---
[View workflow run](https://github.com/fern-api/docs/actions/runs/20139841820)
