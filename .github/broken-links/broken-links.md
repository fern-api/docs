...
- [LOCAL_MISSING] https://github.com/fern-api/fern-platform/blob/app/packages/fern-docs/bundle/src/app/%5Bhost%5D/%5Bdomain%5D/api/fern-docs/auth/fern-token-demo/route.ts (path: packages/fern-docs/bundle/src/app/[host]/[domain]/api/fern-docs/auth/fern-token-demo/route.ts in fern-api/fern-platform, ref: app)

---
[View workflow run](https://github.com/fern-api/docs/actions/runs/20142803094)
